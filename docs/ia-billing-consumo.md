...
Cada execução incrementa `ia_consumo` por competência. Add-ons `ia_1000_interacoes` e `ia_10000_interacoes` ampliam franquias; relatórios, documentos classificados e automações executadas podem alimentar pré-fatura.
