# Manual administrativo SIGOV PLUS Pós-RC 15
...
- Revise artifacts: test-results, docker logs, schema report, smoke MD/JSON, go-live, pacote de release e evidências Pós-RC 15.
