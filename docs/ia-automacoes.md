...
Automações possuem gatilho, condição JSON, ação JSON, status e obrigatoriedade de confirmação. Execuções críticas ficam pendentes de aprovação humana e sempre geram log.
