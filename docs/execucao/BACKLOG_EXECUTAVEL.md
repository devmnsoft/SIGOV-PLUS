...
| 7a | Fatias Compras/Almoxarifado, Jurídico, Educação | AGUARDA_GATE | Educação recebeu correção isolada de integridade em matrícula/frequência na RC51.02L; Gate D após A+B+C ainda exige transferência histórica, correção auditada da chamada, índice por oferta e prova PostgreSQL 16 |
