...
Status: PROPOSTO; cookie compacto e snapshot request-scoped implementados na RC51.02; ACEITO somente após login/isolamento runtime em PostgreSQL 16.
...
Login por CPF, CNPJ e e-mail; `/MinhaCentral`; logout; revogação; API anônima/autenticada; módulo não contratado; tenant suspenso e isolamento entre dois tenants. Código e testes estáticos avançaram na RC51.02; nenhum fluxo runtime foi declarado concluído.
