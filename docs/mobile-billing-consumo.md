...
## Consumo billing
A tabela `sigov.mobile_consumo_billing` consolida `mobile_usuarios_ativos`, `sync_lotes`, `sync_itens`, `fotos_campo`, `storage_campo_mb`, `localizacoes_registradas` e `assinaturas_campo`. Add-ons previstos: `mobile_usuarios_extra`, `storage_fotos_campo`, `geolocalizacao_avancada`, `sincronizacao_offline_avancada`.
