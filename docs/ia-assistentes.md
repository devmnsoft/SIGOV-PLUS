...
Os assistentes cadastrados incluem geral, tributário, financeiro, GED, comercial, indústria, OS, jurídico, contratos e suporte. A tela `/IA/Assistente` permite escolher módulo, informar pergunta/contexto, copiar resposta e gerar sugestão ou relatório.
