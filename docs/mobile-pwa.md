...
## Rotas PWA
- `/Mobile`, `/Mobile/Login`, `/Mobile/Home`, `/Mobile/Offline`, `/Mobile/Sync`, `/Mobile/Agenda`, `/Mobile/Atividades`, `/Mobile/Checklists`, `/Mobile/Evidencias`, `/Mobile/Assinatura`, `/Mobile/Mapa`, `/Mobile/Notificacoes`.
