...
## Sincronização
- Upload: `POST /api/mobile/sync/upload`.
- Download: `GET /api/mobile/sync/download`.
- Lotes e itens preservam falhas por item para não derrubar o lote inteiro.
- Direções previstas: `UPLOAD`, `DOWNLOAD`, `BIDIRECIONAL`.
