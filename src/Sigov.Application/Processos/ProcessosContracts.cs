...
public sealed record MovimentarProcessoRequest(long? UnidadeDestinoId, long? UsuarioDestinoId, string Despacho, string? StatusNovo, string? StatusEsperado = null);
public sealed record EmitirParecerRequest(string Titulo, string Texto, string TipoParecer, bool Sigiloso);
public sealed record EncerrarProcessoRequest(string Justificativa, string? StatusEsperado = null);
public sealed record CancelarProcessoRequest(string Justificativa, string? StatusEsperado = null);
