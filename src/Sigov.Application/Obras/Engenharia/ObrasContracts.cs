...
public sealed record ObrasContexto(long TenantId,long EntidadeId,long? UsuarioId,string CorrelationId,string? Ip);
...
public sealed record ObrasDashboard(long Planejadas,long Contratadas,long EmExecucao,long Paralisadas,long Concluidas,decimal ValorContratado,decimal ValorMedido,decimal SaldoMedir,long MedicoesPendentes,long FiscalizacoesPendentes,long OrdensAbertas);
