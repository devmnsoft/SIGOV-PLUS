...
public sealed class ModuleCatalogService : IModuleCatalogService
{
    ...
    private static IReadOnlyList<ModuleCatalogItem> BuildModules()
    {
        var modules = new[]
        {
            ...
            Create("industria_producao", "Indústria 360", "Indústria", "Produção por ordem, BOM e roteiro versionados, chão de fábrica, qualidade e custos; MRP avançado permanece no roadmap.", ModuleStatus.Disponivel, "bi-cpu", "/Industria/Dashboard", "industria.dashboard.visualizar"),
            ...
            Create("ged", "GED/OCR e Automação Documental", "Documentos", "Estrutura histórica parcial; permanece fora da RC51.00 até comprovação runtime específica.", ModuleStatus.EmImplantacao, "bi-file-earmark-text", "/Ged/Dashboard", "ged.visualizar"),
            Create("ocr", "OCR Documental", "Documentos", "Estrutura histórica parcial; OCR não é promovido como funcional nesta sprint.", ModuleStatus.EmImplantacao, "bi-filetype-txt", "/Ged/Ocr", "ocr.processar"),
            ...
            Create("fluxo", "Workflow e Tramitação", "Automação", "Fluxos documentais históricos aguardam sprint própria para evidência runtime.", ModuleStatus.EmImplantacao, "bi-diagram-2", "/Ged/Workflow", "fluxo.visualizar"),
