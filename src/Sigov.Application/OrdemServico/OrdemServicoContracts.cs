...
public sealed record OrdemServicoChecklistDto(Guid Id, string Titulo, string Tipo, bool Obrigatorio, bool Respondido, string? Resposta, bool BloqueiaConclusao);
