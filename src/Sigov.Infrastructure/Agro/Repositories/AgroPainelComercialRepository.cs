...
public sealed class AgroPainelComercialRepository : IAgroPainelComercialRepository
{
    ...
    {
        const string sql = """
            insert into sigov.agro_painel_comercial_config(tenant_id,entidade_id,titulo,subtitulo,mostrar_produtores,mostrar_producao,mostrar_pecuaria,mostrar_mapa,mostrar_programas,mostrar_estradas,mostrar_feiras,mostrar_agroindustrias,configuracao_json)
