...
using AlmoxarifadoAppService = Sigov.Application.Almoxarifado.IAlmoxarifadoService;
using AlmoxarifadoInfraService = Sigov.Infrastructure.Almoxarifado.AlmoxarifadoService;
using Bloco6AlmoxarifadoAppService = Sigov.Application.Bloco6.IAlmoxarifadoService;
using Bloco6AlmoxarifadoService = Sigov.Application.Bloco6.AlmoxarifadoService;
using Bloco6ComprasAppService = Sigov.Application.Bloco6.IComprasService;
using Bloco6ComprasService = Sigov.Application.Bloco6.ComprasService;
using Bloco6PatrimonioAppService = Sigov.Application.Bloco6.IPatrimonioService;
using Bloco6PatrimonioService = Sigov.Application.Bloco6.PatrimonioService;
using ComprasAppService = Sigov.Application.Compras.IComprasService;
...
public static class DependencyInjection
{
    ...
    {
        services.AddScoped<PatrimonioAppService, PatrimonioInfraService>();
        services.AddScoped<AlmoxarifadoAppService, AlmoxarifadoInfraService>();
        services.AddScoped<IAgroService, AgroService>();
        services.AddScoped<ComprasAppService, ComprasInfraService>();
        ...
        services.AddScoped<IRequestAuthorizationSnapshot, RequestAuthorizationSnapshot>();
        services.AddScoped<IAuthorizationHandler, PersistedPermissionHandler>();
        services.AddScoped<IModuleEntitlementEvaluator, ModuleEntitlementEvaluator>();
        ...
        services.AddScoped<Bloco6ComprasService>();
        services.AddScoped<Bloco6ComprasAppService>(p => p.GetRequiredService<Bloco6ComprasService>());
        services.AddScoped<IComprasSolicitacaoService>(p => p.GetRequiredService<Bloco6ComprasService>());
        services.AddScoped<IComprasOrdemCompraService>(p => p.GetRequiredService<Bloco6ComprasService>());
        ...
        services.AddScoped<Bloco6AlmoxarifadoService>();
        services.AddScoped<Bloco6AlmoxarifadoAppService>(p => p.GetRequiredService<Bloco6AlmoxarifadoService>());
        services.AddScoped<IAlmoxarifadoEstoqueService>(p => p.GetRequiredService<Bloco6AlmoxarifadoService>());
        services.AddScoped<IAlmoxarifadoMovimentoService>(p => p.GetRequiredService<Bloco6AlmoxarifadoService>());
        services.AddScoped<Bloco6PatrimonioService>();
        services.AddScoped<Bloco6PatrimonioAppService>(p => p.GetRequiredService<Bloco6PatrimonioService>());
        services.AddScoped<IPatrimonioMovimentoService>(p => p.GetRequiredService<Bloco6PatrimonioService>());
        ...
        services.AddScoped<Sigov.Application.Saas.Modules.IModuleCatalogService, PersistentModuleCatalogService>();
        ...
        services.AddScoped<PersistentModuleCatalogService>();
        ...
        services.AddScoped<Sigov.Application.Royalties.IRoyaltiesRepository, Sigov.Infrastructure.Royalties.RoyaltiesRepository>();
...
services.AddScoped<Sigov.Application.Fiscalizacao.IFiscalizacaoRepository, Sigov.Infrastructure.Fiscalizacao.FiscalizacaoRepository>();
        return services;
    }
}
