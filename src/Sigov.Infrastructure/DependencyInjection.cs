...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services)
    {
        ...
        services.AddScoped<ITarefaRepository>(provider => provider.GetRequiredService<TarefaRepository>());
        services.AddScoped<ITarefaHistoricoRepository>(provider => provider.GetRequiredService<TarefaRepository>());
        services.AddScoped<IAgendaRepository>(provider => provider.GetRequiredService<TarefaRepository>());
        services.AddScoped<IPrazoOperacionalRepository>(provider => provider.GetRequiredService<TarefaRepository>());
        services.AddScoped<INotificacaoRepository>(provider => provider.GetRequiredService<TarefaRepository>());
        services.AddScoped<INotificacaoPreferenceService>(provider => provider.GetRequiredService<TarefaRepository>());
        services.AddScoped<IKanbanService>(provider => provider.GetRequiredService<TarefaRepository>());
        services.AddScoped<ITarefaNotificationService>(provider => provider.GetRequiredService<TarefaRepository>());
        services.AddScoped<IOperationalEventPublisher>(provider => provider.GetRequiredService<TarefaRepository>());
        services.AddScoped<ITarefaService, TarefaService>();
        services.AddScoped<IAgendaService, AgendaService>();
        services.AddScoped<IPrazoOperacionalService, PrazoOperacionalService>();
