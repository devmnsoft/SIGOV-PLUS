...
public sealed class TenantContextSwitchRepository : ITenantContextSwitchRepository
{
    ...
    {
        const string sql = @"select distinct codigo from (
...
";
    ...
    {
        const string sql = @"insert into sigov.usuario_contexto_global_log (usuario_global_id, tenant_destino_id, entidade_destino_id, motivo, ip, user_agent, correlation_id)
...
";
    ...
    {
        const string sql = @"update sigov.usuario_contexto_global_log
...
";
    ...
    {
        const string sql = @"select id as Id, usuario_global_id as UsuarioGlobalId, tenant_destino_id as TenantDestinoId, entidade_destino_id as EntidadeDestinoId,
