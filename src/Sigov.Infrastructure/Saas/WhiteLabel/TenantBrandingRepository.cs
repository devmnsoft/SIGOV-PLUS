...
public sealed class TenantBrandingRepository : ITenantBrandingRepository
{
    ...
    {
        const string sql = """
            insert into sigov.saas_tenant_branding (tenant_id,nome_exibicao,logo_url,logo_storage_key,cor_primaria,cor_secundaria,cor_acento,tema,favicon_url,css_customizado,white_label_ativo)
