...
public sealed class TenantParameterRepository : ITenantParameterRepository
{
    ...
    {
        const string sql = @"select id as Id, codigo as Codigo, nome as Nome, descricao as Descricao, modulo as Modulo, tipo_parametro as TipoParametro,
...
";
    ...
    {
        const string sql = @"select v.id as Id, v.tenant_id as TenantId, v.entidade_id as EntidadeId, v.exercicio_id as ExercicioId, v.usuario_id as UsuarioId,
...
";
    ...
    {
        const string sql = @"with definicao as (
