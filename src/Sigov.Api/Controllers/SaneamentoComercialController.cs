...
[ApiController, Route("api/saneamento/comercial")] public sealed class SaneamentoComercialController : SaneamentoAvancadoControllerBase
{
 ...
 [HttpPost("ligacoes/{id:long}/instalar-hidrometro")] public async Task<ActionResult<ApiResponse<bool>>> A13(long id,[FromBody] SaneamentoAvancadoOperacaoRequest request,CancellationToken ct)=>Resposta(await _service.AlterarStatusAsync(Contexto(),"saneamento_hidrometro",id,"INSTALADO",request.Justificativa,ct));
