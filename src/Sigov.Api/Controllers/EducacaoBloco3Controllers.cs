...
public sealed class EducacaoSecretariaController : EducacaoApiControllerBase
{
    ...
    [HttpPost("declaracao-frequencia")] public async Task<ActionResult<ApiResponse<long>>> DeclaracaoFrequencia(EducacaoEmitirDeclaracaoFrequenciaRequest r,CancellationToken ct)=>FromResult(await _service.CriarAsync("documento",r,ct));
