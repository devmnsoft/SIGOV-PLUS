...
public sealed class IndustriaController : EnterprisePageControllerBase
{
    ...
    public IActionResult Apontamentos() => IndustriaPage("Apontamentos de Produção", "industria.apontamentos.criar", "/api/industria/ordens-producao");
    public IActionResult Qualidade() => IndustriaPage("Controle de Qualidade", "industria.qualidade.visualizar", "/api/industria/qualidade");
