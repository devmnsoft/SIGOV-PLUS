...
public sealed class IconRegistry : IIconRegistry
{
    ...
    private static IReadOnlyDictionary<string, IconDefinition> Build()
    {
        var navigation = new[]
        {
            "home", "dashboard", "agenda", "tasks", "favorites", "recent", "commercial", "clients", "services",
            "work-order", "assets", "maintenance", "sla", "finance", "documents", "contracts", "users", "settings",
            "help", "notifications", "workflow", "industry", "education", "health", "water", "tax", "audit",
            "protocol", "archive", "cart", "map", "mobile", "shield", "ai", "check", "link", "lock", "user"
        };
