...
$copyFiles = @('README.md','docker-compose.yml','.env.example','docs/release-notes-v1.0.0.md','docs/checklist-go-live-pos-rc.md','docs/roteiro-demo-sigov-plus.md','docs/diagnostico-tecnico-pos-rc-14.md','docs/evidencias-consolidacao-pos-rc-14.md','docs/evidencias-consolidacao-pos-rc-14.json','docs/manual-usuario-sigov-pos-rc-14.md','docs/manual-admin-sigov-pos-rc-14.md','docs/jornadas-operacionais-pos-rc-14.md','docs/matriz-funcional-pos-rc-14.md','docs/matriz-crud-enterprise-pos-rc-14.md','docs/security-lgpd-pos-rc-14.md','docs/checklist-homologacao-pos-rc-14.md','docs/importacao-enterprise-pos-rc-14.md','docs/acoes-lote-enterprise-pos-rc-14.md','docs/anexos-enterprise-ged-pos-rc-14.md','docs/agenda-sla-kanban-pos-rc-14.md','docs/smoke-test-release-candidate.md','docs/smoke-test-release-candidate.json')
...
foreach ($dir in @('database/postgres/migrations','database/postgres/seeds')) { $source = Join-Path $root $dir; if (Test-Path $source) { Copy-Item $source -Destination (Join-Path $package $dir) -Recurse -Force } }
$scriptsOut = Join-Path $package 'scripts'; New-Item -ItemType Directory -Force -Path $scriptsOut | Out-Null
foreach ($name in @('apply-demo-seed','smoke-test-sigov','validate-release','package-release','schema-report','go-live-check')) { foreach ($ext in @('.ps1','.cmd','.sh')) { $source = Join-Path $root "scripts/$name$ext"; if (Test-Path $source) { Copy-Item $source -Destination $scriptsOut } } }
