param(
  [string]$PackagePath = 'artifacts/release/sigov-plus-1.0.0-rc23a',
  [switch]$AllowWarnings,
  [switch]$StaticOnly,
  [string]$ReleaseCandidateVersion = '1.0.0-rc23a'
)
...
$docs=@('README.md','docs/diagnostico-pos-rc-23a-inicial.md','docs/diagnostico-build-pos-rc-20.md','docs/diagnostico-migrations-pos-rc-20.md','docs/evidencias-pos-rc-20.md','docs/testes-pos-rc-20.md','docs/diagnostico-docker-pos-rc-20.md','docs/jornadas-operacionais-pos-rc-15.md','docs/matriz-funcional-pos-rc-15.md','docs/matriz-crud-enterprise-pos-rc-15.md','docs/security-lgpd-pos-rc-15.md','docs/checklist-homologacao-pos-rc-15.md','docs/importacao-enterprise-pos-rc-15.md','docs/acoes-lote-enterprise-pos-rc-15.md','docs/anexos-enterprise-ged-pos-rc-15.md','docs/agenda-sla-kanban-pos-rc-15.md','docs/release-notes-v1.0.0.md','docs/roteiro-demo-sigov-plus.md','docs/checklist-go-live-pos-rc.md')
...
$md=@('# Go-live check Pós-RC 23A','',"Gerado em $($summary.generatedAt).",'',"Resumo: PASS=$($summary.passed) WARN=$($summary.warnings) FAIL_BLOCKING=$($summary.failedBlocking) STATUS=$($summary.statusFinal)",'','| Check | Status | Mensagem |','|---|---|---|')
