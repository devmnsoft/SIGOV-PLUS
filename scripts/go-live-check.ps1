...
$docs=@('README.md','docs/diagnostico-tecnico-pos-rc-14.md','docs/evidencias-consolidacao-pos-rc-14.md','docs/manual-usuario-sigov-pos-rc-14.md','docs/manual-admin-sigov-pos-rc-14.md','docs/jornadas-operacionais-pos-rc-14.md','docs/matriz-funcional-pos-rc-14.md','docs/matriz-crud-enterprise-pos-rc-14.md','docs/security-lgpd-pos-rc-14.md','docs/checklist-homologacao-pos-rc-14.md','docs/importacao-enterprise-pos-rc-14.md','docs/acoes-lote-enterprise-pos-rc-14.md','docs/anexos-enterprise-ged-pos-rc-14.md','docs/agenda-sla-kanban-pos-rc-14.md','docs/release-notes-v1.0.0.md','docs/roteiro-demo-sigov-plus.md','docs/checklist-go-live-pos-rc.md')
...
$md=@('# Go-live check Pós-RC 14','',"Gerado em $($summary.generatedAt).",'',"Resumo: PASS=$($summary.passed) WARN=$($summary.warnings) FAIL_BLOCKING=$($summary.failedBlocking) STATUS=$($summary.statusFinal)",'','| Check | Status | Mensagem |','|---|---|---|')
