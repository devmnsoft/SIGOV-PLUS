...
$enterpriseApiRoutes = @('/api/comercial/clientes','/api/comercial/propostas','/api/comercial/pedidos','/api/os/ordens','/api/estoque/produtos','/api/estoque/saldos','/api/compras/fornecedores','/api/industrial/ativos','/api/industrial/planos-manutencao','/api/industria/ordens-producao')
