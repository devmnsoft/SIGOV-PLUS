...
# Evidências Pós-RC 13 consolidadas a partir do smoke runtime.
$evidenceMd = 'docs/evidencias-consolidacao-pos-rc-13.md'
$evidenceJson = 'docs/evidencias-consolidacao-pos-rc-13.json'
@('# Evidências consolidação Pós-RC 13','',"Gerado em $generatedAt.",'',"Smoke: $success/$total checks OK; falhas bloqueantes: $failedBlocking.",'',"Fonte: execução local/CI de scripts/smoke-test-sigov.ps1.") | Out-File -FilePath $evidenceMd -Encoding utf8
