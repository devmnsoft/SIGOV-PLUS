...
begin
    ...
    values ('Prefeitura Municipal de DemonstraÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o', '00000000000191', true, 'Registro de desenvolvimento sigov')
    ...
    values
        (v_entidade_id, v_exercicio_id, 'core', 'core_admin', 'PermissÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o administrativa do nÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âºcleo', true),
        (v_entidade_id, v_exercicio_id, 'seguranca', 'seguranca_admin', 'PermissÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o administrativa de seguranÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§a', true),
        (v_entidade_id, v_exercicio_id, 'auditoria', 'auditoria_admin', 'PermissÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o administrativa de auditoria', true),
        (v_entidade_id, v_exercicio_id, 'lgpd', 'lgpd_admin', 'PermissÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o administrativa LGPD', true),
        (v_entidade_id, v_exercicio_id, 'suporte', 'suporte_admin', 'PermissÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o administrativa de suporte', true),
        (v_entidade_id, v_exercicio_id, 'conformidade', 'aderencia_admin', 'PermissÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o administrativa de conformidade e aderÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âªncia', true)
    on conflict do nothing;
...
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo) values ('social','AssistÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âªncia Social','MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³dulo base de AssistÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âªncia Social','FinalÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­stico',60,'/Social/Dashboard','bi-people',true) on conflict (codigo) do nothing;
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo) values ('assistencia_social','AssistÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âªncia Social','Alias de licenciamento para AssistÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âªncia Social','FinalÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­stico',61,'/Social/Dashboard','bi-people',true) on conflict (codigo) do nothing;
...
-- Compatibilidade: versÃµes antigas da tabela integracao_sistema exigem a coluna tipo NOT NULL.
ALTER TABLE IF EXISTS sigov.integracao_sistema
    ADD COLUMN IF NOT EXISTS tipo varchar(80);

UPDATE sigov.integracao_sistema
   SET tipo = COALESCE(tipo, tipo_integracao, codigo, 'API')
 WHERE tipo IS NULL;

ALTER TABLE IF EXISTS sigov.integracao_sistema
    ALTER COLUMN tipo SET DEFAULT 'API';
...
insert into sigov.financeiro_configuracao (tenant_id) select id from sigov.tenant on conflict (tenant_id) do nothing;
