...
-- Pode ser executado vÃƒÂ¡rias vezes. NÃƒÂ£o contÃƒÂ©m remoÃƒÂ§ÃƒÂ£o destrutiva.
...
-- As seÃƒÂ§ÃƒÂµes abaixo consolidam as migrations idempotentes do repositÃƒÂ³rio: base, SaaS, tributÃƒÂ¡rio,
-- comercial/varejo/atacado/PDV/caixa, estoque/compras, OS, manutenÃƒÂ§ÃƒÂ£o, mÃƒÂ³dulos pÃƒÂºblicos e indÃƒÂºstria.
...
-- Contexto mantido no cÃƒÂ³digo por bounded context; novas tabelas deste grupo devem ser criadas diretamente no schema sigov.
...
-- Baseline seed tenant obrigatÃƒÂ³rio para bancos limpos e existentes.
...
begin
    ...
    values (1, 'Prefeitura Municipal de DemonstraÃƒÂ§ÃƒÂ£o', '00000000000191', true, 'Registro de desenvolvimento sigov')
    on conflict do nothing;
    ...
    values
        (1, v_entidade_id, v_exercicio_id, 'core', 'core_admin', 'PermissÃƒÂ£o administrativa do nÃƒÂºcleo', true),
        (1, v_entidade_id, v_exercicio_id, 'seguranca', 'seguranca_admin', 'PermissÃƒÂ£o administrativa de seguranÃƒÂ§a', true),
        (1, v_entidade_id, v_exercicio_id, 'auditoria', 'auditoria_admin', 'PermissÃƒÂ£o administrativa de auditoria', true),
        (1, v_entidade_id, v_exercicio_id, 'lgpd', 'lgpd_admin', 'PermissÃƒÂ£o administrativa LGPD', true),
        (1, v_entidade_id, v_exercicio_id, 'suporte', 'suporte_admin', 'PermissÃƒÂ£o administrativa de suporte', true),
        (1, v_entidade_id, v_exercicio_id, 'conformidade', 'aderencia_admin', 'PermissÃƒÂ£o administrativa de conformidade e aderÃƒÂªncia', true)
    on conflict do nothing;
...
begin
    ...
    foreach legacy_schema in array legacy_schemas loop
        if exists (select 1 from information_schema.schemata where schema_name = legacy_schema) then
            ...
            null; -- comando legado omitido por regra de seguranÃƒÂ§a sem remoÃƒÂ§ÃƒÂ£o destrutiva.
            end if;
        end if;
    end loop;
end $$;
...
-- MÃƒÂ³dulo Processos Digitais, Protocolo, GED bÃƒÂ¡sico, Ouvidoria e DiÃƒÂ¡rio Oficial.
...
cross join (values
    ...
    ('LicitaÃƒÂ§ÃƒÂ£o', 'Processos de contrataÃƒÂ§ÃƒÂ£o pÃƒÂºblica', 60),
    ('Requerimento', 'Requerimentos de cidadÃƒÂ£os e empresas', 20),
...
from (values
 ...
 ('processos.ouvidoria.criar','Criar manifestaÃƒÂ§ÃƒÂµes de ouvidoria'),
 ('processos.ouvidoria.responder','Responder manifestaÃƒÂ§ÃƒÂµes de ouvidoria'),
 ('processos.ouvidoria.converter','Converter ouvidoria em processo'),
 ('processos.ouvidoria.arquivar','Arquivar ouvidoria'),
 ('processos.diario.visualizar','Visualizar diÃƒÂ¡rio oficial'),
 ('processos.diario.criar','Criar publicaÃƒÂ§ÃƒÂµes do diÃƒÂ¡rio oficial'),
 ('processos.diario.editar','Editar publicaÃƒÂ§ÃƒÂµes do diÃƒÂ¡rio oficial'),
 ('processos.diario.publicar','Publicar diÃƒÂ¡rio oficial')
...
values ('financeiro', 'Financeiro/SIAFIC', 'Base financeira e orÃƒÂ§amentÃƒÂ¡ria SIAFIC do sigov.', 'Operacional', 20, '/Financeiro', 'cash-coin', true)
...
from (values
 ...
 ('financeiro.orcamento.visualizar','Visualizar orÃƒÂ§amento'),('financeiro.orcamento.criar','Criar orÃƒÂ§amento'),('financeiro.orcamento.editar','Editar orÃƒÂ§amento'),('financeiro.orcamento.movimentar','Movimentar orÃƒÂ§amento'),
 ...
 ('financeiro.liquidacao.visualizar','Visualizar liquidaÃƒÂ§ÃƒÂµes'),('financeiro.liquidacao.criar','Criar liquidaÃƒÂ§ÃƒÂµes'),('financeiro.liquidacao.anular','Anular liquidaÃƒÂ§ÃƒÂµes'),
...
select t.id, e.id, ex.id, '1500', 'Recursos nÃƒÂ£o vinculados de impostos', 'Seed financeiro bÃƒÂ¡sico'
...
-- Etapa 2 - Pessoa e EndereÃƒÂ§o: reforÃƒÂ§os operacionais, ÃƒÂ­ndices e permissÃƒÂµes granulares.
...
values
    ('core', 'pessoas', 'visualizar', 'core.pessoas.visualizar', 'Visualizar pessoas e endereÃƒÂ§os', true),
    ...
    ('core', 'enderecos', 'gerenciar', 'core.enderecos.gerenciar', 'Gerenciar endereÃƒÂ§os de pessoas', true),
    ('core', 'pessoas', 'exportar', 'core.exportar', 'Exportar cadastro de pessoas', true)
on conflict do nothing;
-- >>> database/postgres/migrations/020_rh_completo.sql
-- MÃƒÂ³dulo Recursos Humanos completo: cadastros, folha, ponto, fÃƒÂ©rias, afastamentos, saÃƒÂºde ocupacional,
-- eSocial estrutural, portal do servidor, outbox de eventos e integraÃƒÂ§ÃƒÂ£o futura com Financeiro/SIAFIC.
...
values
    ...
    ('rh', 'financeiro', 'integrar', 'rh.financeiro.integrar', 'Preparar integraÃƒÂ§ÃƒÂ£o de folha com Financeiro/SIAFIC', true)
on conflict do nothing;
-- >>> database/postgres/migrations/021_educacao_base.sql
-- EducaÃƒÂ§ÃƒÂ£o Base: escolas, ano letivo, cursos, turmas, alunos, matrÃƒÂ­culas, frequÃƒÂªncia, avaliaÃƒÂ§ÃƒÂµes,
-- prÃƒÂ©-matrÃƒÂ­cula, Educacenso estrutural, portal educacional, dashboard, auditoria tÃƒÂ©cnica e outbox.
-- Todas as estruturas operacionais permanecem no schema ÃƒÂºnico sigov.
...
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo)
values ('educacao', 'EducaÃƒÂ§ÃƒÂ£o', 'MÃƒÂ³dulo base de gestÃƒÂ£o escolar do sigov', 'Operacional', 40, '/Educacao/Dashboard', 'book', true)
...
('educacao','matricula','visualizar','educacao.matricula.visualizar','Visualizar matrÃƒÂ­culas',true),
('educacao','matricula','criar','educacao.matricula.criar','Criar matrÃƒÂ­cula',true),
('educacao','matricula','cancelar','educacao.matricula.cancelar','Cancelar matrÃƒÂ­cula',true),
('educacao','matricula','transferir','educacao.matricula.transferir','Transferir matrÃƒÂ­cula',true),
...
('educacao','frequencia','visualizar','educacao.frequencia.visualizar','Visualizar frequÃƒÂªncia',true),
('educacao','frequencia','criar','educacao.frequencia.criar','Registrar frequÃƒÂªncia',true),
('educacao','avaliacao','visualizar','educacao.avaliacao.visualizar','Visualizar avaliaÃƒÂ§ÃƒÂµes',true),
('educacao','avaliacao','criar','educacao.avaliacao.criar','Criar avaliaÃƒÂ§ÃƒÂ£o',true),
('educacao','nota','criar','educacao.nota.criar','Registrar nota',true),
('educacao','pre_matricula','visualizar','educacao.pre_matricula.visualizar','Visualizar prÃƒÂ©-matrÃƒÂ­cula',true),
('educacao','pre_matricula','criar','educacao.pre_matricula.criar','Criar prÃƒÂ©-matrÃƒÂ­cula',true),
('educacao','pre_matricula','converter','educacao.pre_matricula.converter','Converter prÃƒÂ©-matrÃƒÂ­cula',true),
...
('educacao','dashboard','visualizar','educacao.dashboard.visualizar','Visualizar dashboard educaÃƒÂ§ÃƒÂ£o',true),
('educacao','exportar','exportar','educacao.exportar','Exportar dados de educaÃƒÂ§ÃƒÂ£o',true)
on conflict do nothing;

-- Seeds de desenvolvimento seguros: sÃƒÂ³ inserem se existir tenant e entidade base.
do $$
declare
    v_tenant bigint;
    v_entidade bigint;
...
begin
    ...
    if v_tenant is not null and v_entidade is not null then
        ...
        values (v_tenant, v_entidade, v_curso, '1ANO', '1Ã‚Âº Ano', 1)
        ...
        if v_escola is not null and v_ano is not null and v_curso is not null and v_serie is not null then
            ...
            values (v_tenant, v_entidade, v_exercicio, v_escola, v_ano, v_curso, v_serie, '1A', '1Ã‚Âº Ano A', 'MATUTINO', 30, 'ABERTA')
            on conflict (tenant_id, entidade_id, ano_letivo_id, codigo) do nothing;
        end if;
    end if;
end $$;
-- >>> database/postgres/migrations/022_saude_acs_base.sql
-- SaÃƒÂºde/ACS base - schema ÃƒÂºnico sigov, PostgreSQL, Dapper-ready e idempotente.
create extension if not exists pgcrypto;
...
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo)
values ('saude', 'SaÃƒÂºde', 'MÃƒÂ³dulo base de saÃƒÂºde, ACS, pacientes, atendimentos, farmÃƒÂ¡cia e vacinaÃƒÂ§ÃƒÂ£o do sigov', 'Operacional', 50, '/Saude/Dashboard', 'heart-pulse', true)
on conflict (codigo) do nothing;

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo)
values ('saude.acs_offline', 'ACS offline estrutural', 'Habilita endpoints e tela de sincronizaÃƒÂ§ÃƒÂ£o offline estrutural do ACS.', 'saude', true)
on conflict (codigo) do nothing;
...
insert into sigov.permissao (modulo, recurso, acao, chave, descricao, ativo)
values
('saude','unidade','visualizar','saude.unidade.visualizar','Visualizar unidades de saÃƒÂºde',true),('saude','unidade','criar','saude.unidade.criar','Criar unidades de saÃƒÂºde',true),('saude','unidade','editar','saude.unidade.editar','Editar unidades de saÃƒÂºde',true),('saude','unidade','excluir','saude.unidade.excluir','Excluir unidades de saÃƒÂºde',true),
('saude','profissional','visualizar','saude.profissional.visualizar','Visualizar profissionais de saÃƒÂºde',true),('saude','profissional','criar','saude.profissional.criar','Criar profissionais de saÃƒÂºde',true),('saude','profissional','editar','saude.profissional.editar','Editar profissionais de saÃƒÂºde',true),('saude','profissional','excluir','saude.profissional.excluir','Excluir profissionais de saÃƒÂºde',true),
...
('saude','prontuario','visualizar','saude.prontuario.visualizar','Visualizar prontuÃƒÂ¡rio',true),('saude','prontuario','editar','saude.prontuario.editar','Editar prontuÃƒÂ¡rio',true),('saude','prontuario','visualizar_dados_sensiveis','saude.prontuario.visualizar_dados_sensiveis','Visualizar dados sensÃƒÂ­veis de prontuÃƒÂ¡rio',true),
...
('saude','farmacia','visualizar','saude.farmacia.visualizar','Visualizar farmÃƒÂ¡cia',true),('saude','farmacia','produto.criar','saude.farmacia.produto.criar','Criar produto de farmÃƒÂ¡cia',true),('saude','farmacia','dispensar','saude.farmacia.dispensar','Dispensar medicamento',true),
('saude','vacinacao','visualizar','saude.vacinacao.visualizar','Visualizar vacinaÃƒÂ§ÃƒÂ£o',true),('saude','vacinacao','criar','saude.vacinacao.criar','Registrar vacinaÃƒÂ§ÃƒÂ£o',true),
('saude','laboratorio','visualizar','saude.laboratorio.visualizar','Visualizar laboratÃƒÂ³rio',true),('saude','laboratorio','criar','saude.laboratorio.criar','Criar exame',true),('saude','laboratorio','resultado','saude.laboratorio.resultado','Registrar resultado de exame',true),
('saude','regulacao','visualizar','saude.regulacao.visualizar','Visualizar regulaÃƒÂ§ÃƒÂ£o',true),('saude','regulacao','criar','saude.regulacao.criar','Criar regulaÃƒÂ§ÃƒÂ£o',true),('saude','regulacao','editar','saude.regulacao.editar','Editar regulaÃƒÂ§ÃƒÂ£o',true),
...
('saude','dashboard','visualizar','saude.dashboard.visualizar','Visualizar dashboard saÃƒÂºde',true),('saude','exportar','exportar','saude.exportar','Exportar dados de saÃƒÂºde',true)
on conflict do nothing;
...
begin
    ...
    if v_tenant is not null and v_entidade is not null then
        ...
        values (v_tenant, v_entidade, 'UBS-DEMO', 'Unidade BÃƒÂ¡sica de SaÃƒÂºde Demo', null, 'BASICA', 'ATIVA', '{}'::jsonb, '{}'::jsonb)
        on conflict (tenant_id, entidade_id, codigo) do nothing;
        ...
        values (v_tenant, v_entidade, 'MED-DEMO', 'Medicamento Demo', 'PrincÃƒÂ­pio ativo demo', 'UN')
        on conflict (tenant_id, entidade_id, codigo) do nothing;
        ...
        if v_unidade is not null and v_produto is not null then
            ...
            values (v_tenant, v_entidade, v_unidade, 'MA-DEMO', 'MicroÃƒÂ¡rea Demo')
            on conflict (tenant_id, entidade_id, codigo) do nothing;
        end if;
    end if;
end $$;
-- >>> database/postgres/migrations/023_saneamento_base.sql
-- Saneamento base - schema ÃƒÂºnico sigov, PostgreSQL, Dapper-ready e idempotente.
create extension if not exists pgcrypto;
...
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo)
values ('saneamento','Saneamento','Consumidores, ligaÃƒÂ§ÃƒÂµes, leituras, faturas, laboratÃƒÂ³rio e rede estrutural.','Operacional',80,'/Saneamento/Dashboard','droplet',true)
on conflict (codigo) do nothing;
...
('saneamento','ligacao','visualizar','saneamento.ligacao.visualizar','Visualizar ligaÃƒÂ§ÃƒÂµes',true),
('saneamento','ligacao','criar','saneamento.ligacao.criar','Criar ligaÃƒÂ§ÃƒÂµes',true),
('saneamento','ligacao','editar','saneamento.ligacao.editar','Editar ligaÃƒÂ§ÃƒÂµes',true),
('saneamento','ligacao','excluir','saneamento.ligacao.excluir','Excluir ligaÃƒÂ§ÃƒÂµes',true),
...
('saneamento','hidrometro','visualizar','saneamento.hidrometro.visualizar','Visualizar hidrÃƒÂ´metros',true),
('saneamento','hidrometro','criar','saneamento.hidrometro.criar','Criar hidrÃƒÂ´metros',true),
('saneamento','hidrometro','editar','saneamento.hidrometro.editar','Editar hidrÃƒÂ´metros',true),
('saneamento','hidrometro','excluir','saneamento.hidrometro.excluir','Excluir hidrÃƒÂ´metros',true),
...
('saneamento','arrecadacao','visualizar','saneamento.arrecadacao.visualizar','Visualizar arrecadaÃƒÂ§ÃƒÂ£o',true),
('saneamento','arrecadacao','criar','saneamento.arrecadacao.criar','Criar arrecadaÃƒÂ§ÃƒÂ£o',true),
...
('saneamento','laboratorio','visualizar','saneamento.laboratorio.visualizar','Visualizar laboratÃƒÂ³rio',true),
...
-- MÃƒÂ³dulo AssistÃƒÂªncia Social Base - schema ÃƒÂºnico sigov, idempotente.
create extension if not exists pgcrypto;
...
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo) values ('social','AssistÃƒÂªncia Social','MÃƒÂ³dulo base de AssistÃƒÂªncia Social','FinalÃƒÂ­stico',60,'/Social/Dashboard','bi-people',true) on conflict (codigo) do nothing;
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo) values ('assistencia_social','AssistÃƒÂªncia Social','Alias de licenciamento para AssistÃƒÂªncia Social','FinalÃƒÂ­stico',61,'/Social/Dashboard','bi-people',true) on conflict (codigo) do nothing;
insert into sigov.permissao (modulo, recurso, acao, chave, descricao, ativo) values
('social','dashboard','visualizar','social.dashboard.visualizar','Visualizar dashboard social',true),('social','unidade','visualizar','social.unidade.visualizar','Visualizar unidades sociais',true),('social','unidade','criar','social.unidade.criar','Criar unidade social',true),('social','unidade','editar','social.unidade.editar','Editar unidade social',true),('social','unidade','excluir','social.unidade.excluir','Excluir unidade social',true),('social','familia','visualizar','social.familia.visualizar','Visualizar famÃƒÂ­lias',true),('social','familia','criar','social.familia.criar','Criar famÃƒÂ­lia',true),('social','familia','editar','social.familia.editar','Editar famÃƒÂ­lia',true),('social','familia','excluir','social.familia.excluir','Excluir famÃƒÂ­lia',true),('social','familia','visualizar_dados_completos','social.familia.visualizar_dados_completos','Visualizar dados completos de famÃƒÂ­lia',true),('social','pessoa','visualizar','social.pessoa.visualizar','Visualizar pessoas sociais',true),('social','pessoa','criar','social.pessoa.criar','Criar pessoa social',true),('social','pessoa','editar','social.pessoa.editar','Editar pessoa social',true),('social','pessoa','excluir','social.pessoa.excluir','Excluir pessoa social',true),('social','cadastro','criar','social.cadastro.criar','Criar cadastro social',true),('social','vulnerabilidade','criar','social.vulnerabilidade.criar','Registrar vulnerabilidade',true),('social','programa','visualizar','social.programa.visualizar','Visualizar programas',true),('social','programa','criar','social.programa.criar','Criar programa',true),('social','programa','editar','social.programa.editar','Editar programa',true),('social','programa','excluir','social.programa.excluir','Excluir programa',true),('social','beneficio','visualizar','social.beneficio.visualizar','Visualizar benefÃƒÂ­cios',true),('social','beneficio','criar','social.beneficio.criar','Criar benefÃƒÂ­cio',true),('social','beneficio','editar','social.beneficio.editar','Editar benefÃƒÂ­cio',true),('social','beneficio','conceder','social.beneficio.conceder','Conceder benefÃƒÂ­cio',true),('social','beneficio','autorizar','social.beneficio.autorizar','Autorizar benefÃƒÂ­cio',true),('social','beneficio','entregar','social.beneficio.entregar','Entregar benefÃƒÂ­cio',true),('social','atendimento','visualizar','social.atendimento.visualizar','Visualizar atendimentos',true),('social','atendimento','criar','social.atendimento.criar','Criar atendimento',true),('social','atendimento','encaminhar','social.atendimento.encaminhar','Criar encaminhamento',true),('social','visita','visualizar','social.visita.visualizar','Visualizar visitas',true),('social','visita','criar','social.visita.criar','Criar visita',true),('social','parecer','visualizar','social.parecer.visualizar','Visualizar pareceres',true),('social','parecer','criar','social.parecer.criar','Criar parecer',true),('social','parecer','visualizar_sigiloso','social.parecer.visualizar_sigiloso','Visualizar parecer sigiloso',true),('social','acompanhamento','visualizar','social.acompanhamento.visualizar','Visualizar acompanhamento',true),('social','acompanhamento','criar','social.acompanhamento.criar','Criar acompanhamento',true),('social','acompanhamento','encerrar','social.acompanhamento.encerrar','Encerrar acompanhamento',true),('social','vigilancia','visualizar','social.vigilancia.visualizar','Visualizar vigilÃƒÂ¢ncia',true),('social','vigilancia','criar','social.vigilancia.criar','Criar vigilÃƒÂ¢ncia',true),('social','exportar','executar','social.exportar','Exportar dados sociais',true) on conflict (modulo, recurso, acao) do nothing;
-- >>> database/postgres/migrations/025_integracoes_outbox_webhooks_base.sql
-- SIGOV - IntegraÃƒÂ§ÃƒÂµes oficiais, outbox avanÃƒÂ§ado, webhooks, API credentials e estruturas Gov.br/ICP-Brasil.
-- Migration incremental e idempotente; todas as tabelas permanecem no schema ÃƒÂºnico sigov.
...
insert into sigov.modulo_saas (codigo,nome,descricao,categoria,ordem,rota_base,icone,ativo)
values ('integracao','IntegraÃƒÂ§ÃƒÂµes','IntegraÃƒÂ§ÃƒÂµes oficiais, API credentials, webhooks, outbox, Gov.br e ICP-Brasil estrutural.','Plataforma',90,'/Integracoes','bi-diagram-3',true)
...
('integracao','integracao.sistema.visualizar','integracao.sistema','visualizar','Visualizar sistemas de integraÃƒÂ§ÃƒÂ£o',true),
('integracao','integracao.sistema.criar','integracao.sistema','criar','Criar sistemas de integraÃƒÂ§ÃƒÂ£o',true),
('integracao','integracao.sistema.editar','integracao.sistema','editar','Editar sistemas de integraÃƒÂ§ÃƒÂ£o',true),
('integracao','integracao.sistema.excluir','integracao.sistema','excluir','Excluir sistemas de integraÃƒÂ§ÃƒÂ£o',true),
...
('integracao','integracao.dashboard.visualizar','integracao.dashboard','visualizar','Visualizar dashboard de integraÃƒÂ§ÃƒÂµes',true),
('integracao','integracao.exportar','integracao.exportacao','exportar','Exportar dados de integraÃƒÂ§ÃƒÂµes',true)
...
-- Agro e Desenvolvimento Rural - fundaÃƒÂ§ÃƒÂ£o, georreferenciamento estrutural e dashboard inicial.
-- Schema ÃƒÂºnico sigov; sem PostGIS obrigatÃƒÂ³rio; Dapper/PostgreSQL-ready.

insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo)
values ('agro', 'Agro e Desenvolvimento Rural', 'FundaÃƒÂ§ÃƒÂ£o do mÃƒÂ³dulo Agro com georreferenciamento estrutural e dashboard inicial.', 'PolÃƒÂ­ticas pÃƒÂºblicas', 160, '/Agro/Dashboard', 'bi-tree', true)
...
('agro','geo','visualizar','agro.geo.visualizar','Visualizar camadas e feiÃƒÂ§ÃƒÂµes geogrÃƒÂ¡ficas do Agro.',true),
('agro','geo','criar','agro.geo.criar','Criar camadas e feiÃƒÂ§ÃƒÂµes geogrÃƒÂ¡ficas do Agro.',true),
('agro','geo','editar','agro.geo.editar','Editar camadas e feiÃƒÂ§ÃƒÂµes geogrÃƒÂ¡ficas do Agro.',true),
('agro','geo','excluir','agro.geo.excluir','Excluir camadas e feiÃƒÂ§ÃƒÂµes geogrÃƒÂ¡ficas do Agro.',true),
('agro','geo','exportar','agro.geo.exportar','Exportar dados geogrÃƒÂ¡ficos do Agro em GeoJSON.',true)
on conflict (modulo, recurso, acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo)
values
('agro.dashboard','Dashboard Agro','Habilita o dashboard inicial do mÃƒÂ³dulo Agro.','agro',true),
('agro.geo','Georreferenciamento Agro','Habilita camadas e feiÃƒÂ§ÃƒÂµes geogrÃƒÂ¡ficas estruturais do Agro.','agro',true),
('agro.exportacao_geojson','ExportaÃƒÂ§ÃƒÂ£o GeoJSON Agro','Habilita exportaÃƒÂ§ÃƒÂ£o estrutural GeoJSON do Agro.','agro',true)
...
-- FundaÃƒÂ§ÃƒÂ£o SaaS parametrizÃƒÂ¡vel do sigov: schema ÃƒÂºnico sigov, Dapper/PostgreSQL e isolamento por tenant.
...
('ADMINISTRADOR_GERAL', 'Administrador Geral', 'Administra todo o sigov e todos os tenants com auditoria obrigatÃƒÂ³ria.', 1000, true, false),
('ADMINISTRADOR_TENANT', 'Administrador do Tenant', 'Administra apenas o prÃƒÂ³prio tenant.', 900, false, true),
('ADMINISTRADOR_ENTIDADE', 'Administrador de Entidade', 'Administra uma entidade especÃƒÂ­fica dentro do tenant.', 800, false, false),
('COORDENADOR', 'Coordenador', 'Coordena mÃƒÂ³dulos, setores, equipes ou unidades conforme permissÃƒÂµes.', 700, false, false),
('DIRETOR', 'Diretor', 'Gerencia unidade, escola, secretaria, departamento ou ÃƒÂ¡rea conforme escopo.', 600, false, false),
('SERVIDOR', 'Servidor', 'Executa tarefas operacionais prÃƒÂ³prias ou atribuÃƒÂ­das.', 500, false, false),
('OPERADOR', 'Operador', 'Executa permissÃƒÂµes operacionais explÃƒÂ­citas.', 400, false, false),
('CONSULTA', 'Consulta', 'UsuÃƒÂ¡rio somente leitura conforme escopo.', 300, false, false),
('AUDITOR', 'Auditor', 'Acessa auditoria e conformidade conforme permissÃƒÂ£o.', 200, false, false),
('SUPORTE', 'Suporte', 'Suporte tÃƒÂ©cnico controlado e auditado.', 100, false, false)
...
('ESSENCIAL','Essencial','FundaÃƒÂ§ÃƒÂ£o mÃƒÂ­nima da plataforma.','["core","seguranca","auditoria","lgpd","suporte"]'::jsonb),
('FINANCEIRO_TRIBUTARIO','Financeiro e TributÃƒÂ¡rio','GestÃƒÂ£o fiscal, arrecadaÃƒÂ§ÃƒÂ£o e relatÃƒÂ³rios.','["financeiro","tributario","relatorios"]'::jsonb),
('GESTAO_ADMINISTRATIVA','GestÃƒÂ£o Administrativa','Backoffice administrativo municipal.','["processos","compras","contratos","almoxarifado","patrimonio","frotas","obras"]'::jsonb),
('SOCIAL_SAUDE_EDUCACAO','Social, SaÃƒÂºde e EducaÃƒÂ§ÃƒÂ£o','PolÃƒÂ­ticas pÃƒÂºblicas integradas.','["educacao","saude","social"]'::jsonb),
('AGRO_RURAL','Agro Rural','Base futura rural integrada.','["agro","frotas","obras","tributario","relatorios"]'::jsonb),
('COMPLETO','Completo','Todos os mÃƒÂ³dulos integrados do sigov.','["core","seguranca","auditoria","lgpd","processos","financeiro","tributario","compras","contratos","almoxarifado","patrimonio","frotas","obras","rh","educacao","saude","saneamento","social","relatorios","transparencia","integracoes","suporte","operacao","agro"]'::jsonb)
...
('agro','talhao','visualizar','agro.talhao.visualizar','Visualizar talhÃƒÂµes.',true),('agro','talhao','criar','agro.talhao.criar','Criar talhÃƒÂµes.',true),('agro','talhao','editar','agro.talhao.editar','Editar talhÃƒÂµes.',true),
...
('agro','producao','visualizar','agro.producao.visualizar','Visualizar produÃƒÂ§ÃƒÂ£o agrÃƒÂ­cola.',true),('agro','producao','criar','agro.producao.criar','Criar produÃƒÂ§ÃƒÂ£o agrÃƒÂ­cola.',true),('agro','producao','editar','agro.producao.editar','Editar produÃƒÂ§ÃƒÂ£o agrÃƒÂ­cola.',true),('agro','producao','excluir','agro.producao.excluir','Excluir produÃƒÂ§ÃƒÂ£o agrÃƒÂ­cola.',true)
on conflict (chave) do update set descricao=excluded.descricao, ativo=true, is_deleted=false;

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo)
values ('agro.produtores','Produtores rurais','Habilita cadastro de produtores rurais.','agro',true),('agro.producao','ProduÃƒÂ§ÃƒÂ£o agrÃƒÂ­cola','Habilita cadastros produtivos agrÃƒÂ­colas.','agro',true)
...
select t.id, e.id, x.codigo, x.nome, x.tipo, x.unidade, null from sigov.tenant t join sigov.entidade e on e.tenant_id=t.id cross join (values ('MILHO','Milho','GRAOS','kg'),('FEIJAO','FeijÃƒÂ£o','GRAOS','kg'),('MANDIOCA','Mandioca','RAIZES_TUBERCULOS','kg'),('ARROZ','Arroz','GRAOS','kg'),('HORTALICAS','HortaliÃƒÂ§as','HORTALICAS','kg'),('FRUTAS','Frutas','FRUTAS','kg'),('PASTAGEM','Pastagem','PASTAGEM','ha')) as x(codigo,nome,tipo,unidade) where t.ambiente='Development' and not exists (select 1 from sigov.agro_cultura c where c.tenant_id=t.id and c.entidade_id=e.id and c.codigo=x.codigo and c.is_deleted=false);
...
-- Agro Parte 4: programas, benefÃƒÂ­cios, insumos e patrulha mecanizada.
-- Schema ÃƒÂºnico sigov; migration idempotente; sem schemas agro/rural/geo.

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo)
values
('agro.programas_rurais','Programas rurais','Habilita programas rurais do Agro.','agro',true),
('agro.beneficios_rurais','BenefÃƒÂ­cios rurais','Habilita benefÃƒÂ­cios e concessÃƒÂµes rurais.','agro',true),
('agro.insumos','Insumos Agro','Habilita insumos e distribuiÃƒÂ§ÃƒÂµes rurais.','agro',true),
('agro.patrulha_mecanizada','Patrulha mecanizada','Habilita patrulha mecanizada rural.','agro',true),
('agro.maquinas','MÃƒÂ¡quinas rurais','Habilita mÃƒÂ¡quinas e implementos rurais.','agro',true),
('agro.servicos_maquina','ServiÃƒÂ§os de mÃƒÂ¡quinas','Habilita serviÃƒÂ§os de mÃƒÂ¡quinas rurais.','agro',true)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, modulo=excluded.modulo, ativo=true;
...
('agro','beneficio','visualizar','agro.beneficio.visualizar','Visualizar benefÃƒÂ­cios rurais.',true),('agro','beneficio','criar','agro.beneficio.criar','Criar benefÃƒÂ­cios rurais.',true),('agro','beneficio','editar','agro.beneficio.editar','Editar benefÃƒÂ­cios rurais.',true),('agro','beneficio','excluir','agro.beneficio.excluir','Excluir benefÃƒÂ­cios rurais.',true),('agro','beneficio','conceder','agro.beneficio.conceder','Solicitar concessÃƒÂµes de benefÃƒÂ­cio rural.',true),('agro','beneficio','autorizar','agro.beneficio.autorizar','Autorizar concessÃƒÂµes de benefÃƒÂ­cio rural.',true),('agro','beneficio','entregar','agro.beneficio.entregar','Entregar concessÃƒÂµes de benefÃƒÂ­cio rural.',true),('agro','beneficio','indeferir','agro.beneficio.indeferir','Indeferir concessÃƒÂµes de benefÃƒÂ­cio rural.',true),('agro','beneficio','cancelar','agro.beneficio.cancelar','Cancelar concessÃƒÂµes de benefÃƒÂ­cio rural.',true),
...
('agro','maquina','visualizar','agro.maquina.visualizar','Visualizar mÃƒÂ¡quinas rurais.',true),('agro','maquina','criar','agro.maquina.criar','Criar mÃƒÂ¡quinas rurais.',true),('agro','maquina','editar','agro.maquina.editar','Editar mÃƒÂ¡quinas rurais.',true),('agro','maquina','excluir','agro.maquina.excluir','Excluir mÃƒÂ¡quinas rurais.',true),
...
('agro','servico_maquina','visualizar','agro.servico_maquina.visualizar','Visualizar serviÃƒÂ§os de mÃƒÂ¡quinas.',true),('agro','servico_maquina','criar','agro.servico_maquina.criar','Criar serviÃƒÂ§os de mÃƒÂ¡quinas.',true),('agro','servico_maquina','editar','agro.servico_maquina.editar','Editar serviÃƒÂ§os de mÃƒÂ¡quinas.',true),('agro','servico_maquina','agendar','agro.servico_maquina.agendar','Agendar serviÃƒÂ§os de mÃƒÂ¡quinas.',true),('agro','servico_maquina','executar','agro.servico_maquina.executar','Executar serviÃƒÂ§os de mÃƒÂ¡quinas.',true),('agro','servico_maquina','cancelar','agro.servico_maquina.cancelar','Cancelar serviÃƒÂ§os de mÃƒÂ¡quinas.',true),('agro','servico_maquina','excluir','agro.servico_maquina.excluir','Excluir serviÃƒÂ§os de mÃƒÂ¡quinas.',true)
on conflict (modulo, recurso, acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;
...
select t.id, e.id, x.codigo, x.nome, x.tipo, 'Seed Development Agro Parte 4', null from sigov.tenant t join sigov.entidade e on e.tenant_id=t.id cross join (values ('CORTE_TERRA','Corte de Terra','CORTE_TERRA'),('DIST_SEMENTES','DistribuiÃƒÂ§ÃƒÂ£o de Sementes','DISTRIBUICAO_SEMENTES'),('DIST_MUDAS','DistribuiÃƒÂ§ÃƒÂ£o de Mudas','DISTRIBUICAO_MUDAS'),('PATRULHA_MEC','Patrulha Mecanizada','PATRULHA_MECANIZADA')) as x(codigo,nome,tipo)
...
select t.id, e.id, x.codigo, x.nome, x.tipo, x.unidade, false, null from sigov.tenant t join sigov.entidade e on e.tenant_id=t.id cross join (values ('SEMENTE','Semente','SEMENTE','kg'),('MUDA','Muda','MUDA','un'),('CALCARIO','CalcÃƒÂ¡rio','CALCARIO','kg'),('ADUBO','Adubo','ADUBO','kg')) as x(codigo,nome,tipo,unidade)
...
create table if not exists sigov.b2b_tenant_white_label (
    ...
    nome_plataforma varchar(160) not null default 'PlantÃƒÂ£oPro',
    nome_comercial varchar(160) not null default 'PlantÃƒÂ£oPro',
...
values
('ESSENCIAL', 'Plano Essencial', 'OperaÃƒÂ§ÃƒÂ£o inicial para escalas e plantÃƒÂµes mÃƒÂ©dicos.', 'Hospitais e clÃƒÂ­nicas em inÃƒÂ­cio de operaÃƒÂ§ÃƒÂ£o digital', 499, false, false, 5, 20, 2, 100, 'Suporte padrÃƒÂ£o', 10),
('PROFISSIONAL', 'Plano Profissional', 'OperaÃƒÂ§ÃƒÂ£o assistida com API limitada, relatÃƒÂ³rios avanÃƒÂ§ados e white label bÃƒÂ¡sico.', 'OperaÃƒÂ§ÃƒÂµes multiunidade em crescimento', 1499, true, true, 20, 100, 10, 500, 'Suporte prioritÃƒÂ¡rio', 20),
('ENTERPRISE_WHITE_LABEL', 'Enterprise White Label', 'White label completo, domÃƒÂ­nio customizado, API, webhooks, BI e SLA.', 'Redes de saÃƒÂºde e operaÃƒÂ§ÃƒÂµes B2B', 4990, true, true, 999999, 999999, 999999, 999999, 'SLA contratual', 30),
('REVENDEDOR', 'Plano Revendedor', 'Console parceiro, tenants vinculados, margem, comissÃƒÂ£o e repasses.', 'Parceiros e consultorias', 7990, true, true, 999999, 999999, 999999, 999999, 'SLA B2B para parceiros', 40),
('CUSTOM', 'Plano Custom', 'Contrato personalizado, integraÃƒÂ§ÃƒÂµes especÃƒÂ­ficas e infraestrutura dedicada opcional.', 'Projetos sob proposta', 0, true, true, 999999, 999999, 999999, 999999, 'SLA customizado', 50)
...
values
('One page comercial PlantÃƒÂ£oPro', 'ONE_PAGE', 'parceiro', 'Resumo comercial para hospitais, redes de saÃƒÂºde e parceiros.'),
('Roteiro de demonstraÃƒÂ§ÃƒÂ£o white label', 'DEMO', 'interno', 'Fluxo de planos, self-service, white label, API, suporte e monitoramento.'),
('ArgumentÃƒÂ¡rio para CTO', 'ARGUMENTARIO', 'parceiro', 'SeguranÃƒÂ§a, isolamento por tenant, API keys, LGPD, auditoria e observabilidade.'),
('Proposta comercial modelo', 'PROPOSTA', 'interno', 'Modelo de proposta B2B com setup, SLA, revenda e customizaÃƒÂ§ÃƒÂµes.')
on conflict do nothing;
...
values
('ESSENCIAL','Essencial','Core, SeguranÃƒÂ§a, Auditoria/LGPD e suporte bÃƒÂ¡sico.',true,false,10,'PUBLICO',null,'MENSAL',20,2,10240,false,false),
('FINANCEIRO_TRIBUTARIO','Financeiro e TributÃƒÂ¡rio','Pacote para financeiro, tributÃƒÂ¡rio e relatÃƒÂ³rios.',true,false,20,'PUBLICO',null,'MENSAL',50,5,20480,false,false),
('GESTAO_ADMINISTRATIVA','GestÃƒÂ£o Administrativa','Processos, compras, contratos, almoxarifado, patrimÃƒÂ´nio, frotas e obras.',true,false,30,'PUBLICO',null,'MENSAL',100,10,51200,false,false),
('SOCIAL_SAUDE_EDUCACAO','Social, SaÃƒÂºde e EducaÃƒÂ§ÃƒÂ£o','EducaÃƒÂ§ÃƒÂ£o, saÃƒÂºde e assistÃƒÂªncia social integradas.',true,false,40,'PUBLICO',null,'MENSAL',150,20,102400,false,false),
('AGRO_RURAL','Agro Rural','Agro, frotas, obras e relatÃƒÂ³rios com tributÃƒÂ¡rio opcional.',true,false,50,'PUBLICO',null,'MENSAL',60,10,51200,false,false),
('COMPLETO','Completo','Todos os mÃƒÂ³dulos do sigov com white label e domÃƒÂ­nio customizado.',true,true,60,'PUBLICO',null,'MENSAL',300,50,204800,true,true),
('ENTERPRISE','Enterprise','Plano personalizado para operaÃƒÂ§ÃƒÂ£o municipal avanÃƒÂ§ada.',true,false,70,'ENTERPRISE',null,'PERSONALIZADA',null,null,null,true,true)
...
values
('USUARIOS_EXTRAS','UsuÃƒÂ¡rios extras','Pacote adicional de usuÃƒÂ¡rios.','USUARIOS_EXTRAS',null,null,'MENSAL'),
('ARMAZENAMENTO_EXTRA','Armazenamento extra','Armazenamento adicional.','ARMAZENAMENTO_EXTRA',null,null,'MENSAL'),
('WHITE_LABEL','White label','Identidade visual prÃƒÂ³pria do tenant.','WHITE_LABEL',null,null,'MENSAL'),
('DOMINIO_CUSTOMIZADO','DomÃƒÂ­nio customizado','DomÃƒÂ­nio estrutural customizado.','DOMINIO_CUSTOMIZADO',null,null,'MENSAL'),
('SUPORTE_PREMIUM','Suporte premium','Suporte tÃƒÂ©cnico ampliado.','SUPORTE_PREMIUM',null,null,'MENSAL'),
('TRIBUTARIO_EXTRA','TributÃƒÂ¡rio opcional','MÃƒÂ³dulo TributÃƒÂ¡rio adicional.','MODULO_EXTRA','tributario',null,'MENSAL')
...
from sigov.saas_plano p
join (values
('usuarios','UsuÃƒÂ¡rios',null,'usuarios',false),('entidades','Entidades',null,'entidades',false),('armazenamento_mb','Armazenamento',null,'MB',false),('api_requests_mes','RequisiÃƒÂ§ÃƒÂµes API/mÃƒÂªs',50000,'requests',false),('relatorios_agendados','RelatÃƒÂ³rios agendados',10,'relatÃƒÂ³rios',false),('integracoes','IntegraÃƒÂ§ÃƒÂµes',3,'integraÃƒÂ§ÃƒÂµes',false),('white_label','White label',null,null,false),('dominio_customizado','DomÃƒÂ­nio customizado',null,null,false)
...
('COORDENADOR','Coordenador','COORDENADOR','Coordena mÃƒÂ³dulos, setores ou unidades permitidas.', '[]'::jsonb),
...
('AUDITOR','Auditor','AUDITOR','Acessa auditoria e conformidade conforme permissÃƒÂ£o.', '["saas.assinaturas.visualizar"]'::jsonb)
...
-- Agro Parte 5 - Estradas vicinais, pontos crÃƒÂ­ticos, feiras, agroindÃƒÂºstrias e compras AF.
-- Idempotente; schema ÃƒÂºnico sigov; sem PostGIS obrigatÃƒÂ³rio; sem integraÃƒÂ§ÃƒÂµes financeiras/tributÃƒÂ¡rias reais.

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo) values
('agro.estradas_vicinais','Estradas Vicinais','Habilita cadastro e gestÃƒÂ£o de estradas vicinais.','agro',true),
('agro.pontos_criticos','Pontos CrÃƒÂ­ticos Rurais','Habilita pontes, bueiros, passagens molhadas e pontos crÃƒÂ­ticos.','agro',true),
('agro.ocorrencias_rurais','OcorrÃƒÂªncias Rurais','Habilita ocorrÃƒÂªncias rurais estruturais.','agro',true),
('agro.feiras','Feiras e Mercados Rurais','Habilita feiras, feirantes, bancas e autorizaÃƒÂ§ÃƒÂµes.','agro',true),
('agro.agroindustrias','AgroindÃƒÂºstrias','Habilita agroindÃƒÂºstrias municipais estruturais.','agro',true),
('agro.inspecao_municipal','InspeÃƒÂ§ÃƒÂ£o Municipal','Habilita inspeÃƒÂ§ÃƒÂ£o municipal estrutural.','agro',true),
...
('agro','ponto_critico','visualizar','agro.ponto_critico.visualizar','Visualizar pontos crÃƒÂ­ticos.',true),('agro','ponto_critico','criar','agro.ponto_critico.criar','Criar pontos crÃƒÂ­ticos.',true),('agro','ponto_critico','editar','agro.ponto_critico.editar','Editar pontos crÃƒÂ­ticos.',true),('agro','ponto_critico','resolver','agro.ponto_critico.resolver','Resolver pontos crÃƒÂ­ticos.',true),
('agro','ocorrencia','visualizar','agro.ocorrencia.visualizar','Visualizar ocorrÃƒÂªncias rurais.',true),('agro','ocorrencia','criar','agro.ocorrencia.criar','Criar ocorrÃƒÂªncias rurais.',true),('agro','ocorrencia','editar','agro.ocorrencia.editar','Editar ocorrÃƒÂªncias rurais.',true),('agro','ocorrencia','resolver','agro.ocorrencia.resolver','Resolver ocorrÃƒÂªncias rurais.',true),('agro','ocorrencia','cancelar','agro.ocorrencia.cancelar','Cancelar ocorrÃƒÂªncias rurais.',true),
('agro','manutencao','visualizar','agro.manutencao.visualizar','Visualizar manutenÃƒÂ§ÃƒÂµes rurais.',true),('agro','manutencao','criar','agro.manutencao.criar','Criar manutenÃƒÂ§ÃƒÂµes rurais.',true),('agro','manutencao','executar','agro.manutencao.executar','Executar manutenÃƒÂ§ÃƒÂµes rurais.',true),('agro','manutencao','cancelar','agro.manutencao.cancelar','Cancelar manutenÃƒÂ§ÃƒÂµes rurais.',true),
...
('agro','agroindustria','visualizar','agro.agroindustria.visualizar','Visualizar agroindÃƒÂºstrias.',true),('agro','agroindustria','criar','agro.agroindustria.criar','Criar agroindÃƒÂºstrias.',true),('agro','agroindustria','editar','agro.agroindustria.editar','Editar agroindÃƒÂºstrias.',true),('agro','agroindustria','excluir','agro.agroindustria.excluir','Excluir agroindÃƒÂºstrias.',true),
('agro','inspecao','visualizar','agro.inspecao.visualizar','Visualizar inspeÃƒÂ§ÃƒÂµes municipais.',true),('agro','inspecao','criar','agro.inspecao.criar','Criar inspeÃƒÂ§ÃƒÂµes municipais.',true),('agro','inspecao','concluir','agro.inspecao.concluir','Concluir inspeÃƒÂ§ÃƒÂµes municipais.',true),
...
select t.id, e.id, c.codigo, c.nome, c.tipo, c.nome, false from sigov.tenant t join sigov.entidade e on e.tenant_id=t.id cross join (values ('ESTRADAS_VICINAIS','Estradas Vicinais','ESTRADAS'),('PONTOS_CRITICOS','Pontos CrÃƒÂ­ticos','PONTOS_CRITICOS'),('OCORRENCIAS_RURAIS','OcorrÃƒÂªncias Rurais','OCORRENCIAS'),('FEIRAS_RURAIS','Feiras','FEIRAS'),('AGROINDUSTRIAS','AgroindÃƒÂºstrias','AGROINDUSTRIAS')) c(codigo,nome,tipo) where t.ativo=true and t.is_deleted=false on conflict do nothing;
...
-- Eventos estruturais previstos para sigov.agro_evento/sigov.fila_evento, sem integraÃƒÂ§ÃƒÂ£o real nesta etapa:
...
-- AgroGeoFeicaoAtualizada. Payload mÃƒÂ­nimo: tenantId, entidadeId, exercicioId, origem, origemId, tipoEvento, correlationId.
...
from sigov.tenant t
cross join (values
('total_produtores','Total de produtores','PRODUTORES',null),('total_propriedades','Total de propriedades','PROPRIEDADES',null),('area_produtiva_ha','ÃƒÂrea produtiva','PROPRIEDADES','ha'),('total_culturas','Total de culturas','PRODUCAO',null),('producao_estimada','ProduÃƒÂ§ÃƒÂ£o estimada','PRODUCAO',null),('producao_realizada','ProduÃƒÂ§ÃƒÂ£o realizada','PRODUCAO',null),('total_rebanhos','Total de rebanhos','PECUARIA',null),('total_animais','Total de animais','PECUARIA',null),('visitas_tecnicas_mes','Visitas tÃƒÂ©cnicas no mÃƒÂªs','ASSISTENCIA_TECNICA',null),('beneficios_entregues_mes','BenefÃƒÂ­cios entregues no mÃƒÂªs','PROGRAMAS',null),('servicos_maquina_executados_mes','ServiÃƒÂ§os de mÃƒÂ¡quina executados no mÃƒÂªs','PATRULHA_MECANIZADA',null),('estradas_vicinais_km','Estradas vicinais em km','ESTRADAS','km'),('pontos_criticos_abertos','Pontos crÃƒÂ­ticos abertos','ESTRADAS',null),('feiras_ativas','Feiras ativas','FEIRAS',null),('agroindustrias_ativas','AgroindÃƒÂºstrias ativas','AGROINDUSTRIA',null),('compras_af_mes','Compras da agricultura familiar no mÃƒÂªs','COMPRAS_AF',null)
...
('agro_produtor','pessoa_id','Pessoa do produtor','ReferÃƒÂªncia interna ao cadastro de pessoa; nunca expor em dados abertos.','PRODUTORES',true,false,false,'ID_INTERNO'),
('agro_propriedade','endereco_json','EndereÃƒÂ§o da propriedade','EndereÃƒÂ§o completo deve ser mascarado em exportaÃƒÂ§ÃƒÂµes pÃƒÂºblicas.','PROPRIEDADES',true,false,false,'ENDERECO_MASCARADO'),
('agro_agroindustria','endereco_json','EndereÃƒÂ§o da agroindÃƒÂºstria','EndereÃƒÂ§o completo deve ser mascarado em exportaÃƒÂ§ÃƒÂµes pÃƒÂºblicas.','AGROINDUSTRIA',true,false,false,'ENDERECO_MASCARADO'),
('agro_compra_agricultura_familiar','produto','Produto adquirido','Campo publicÃƒÂ¡vel apenas agregado por produto.','COMPRAS_AF',false,false,true,null)
on conflict do nothing;
...
values ('Administrador Geral', 'Perfil global para administraÃƒÂ§ÃƒÂ£o SaaS inicial do SIGOV.', 'ADMINISTRADOR_GERAL', true)
on conflict do nothing;
...
values
    ...
    ('saas', 'modulos', 'visualizar', 'saas.modulos.visualizar', 'Visualizar mÃƒÂ³dulos SaaS', true),
    ('saas', 'modulos', 'gerenciar', 'saas.modulos.gerenciar', 'Gerenciar mÃƒÂ³dulos contratados', true),
    ('operacao', 'health', 'visualizar', 'operacao.health.visualizar', 'Visualizar saÃƒÂºde do ambiente', true)
on conflict do nothing;

insert into sigov.usuario (tenant_id, login, email, senha_hash, nome, ativo, bloqueado, deve_alterar_senha, observacao)
select t.id, 'admin', 'admin@sigov.local', 'SIGOV_PBKDF2_V1$100000$UG9zdEJ1aWxkMDFTYWx0IQ==$C87vVWxqrRbbxe7IoBsv0wuI7NDFYnsFlrAxvqlherg=', 'Administrador Geral', true, false, true, 'UsuÃƒÂ¡rio administrador inicial de desenvolvimento com senha documentada em docs/ambiente-local.md'
from sigov.tenant t
...
-- EvoluÃƒÂ§ÃƒÂ£o PÃƒÂ³s-Build 03 - Planos SaaS, implantaÃƒÂ§ÃƒÂ£o guiada e base tributÃƒÂ¡ria parametrizÃƒÂ¡vel.
-- Migration idempotente: somente CREATE/ALTER IF NOT EXISTS, ÃƒÂ­ndices IF NOT EXISTS e seeds ON CONFLICT.
...
values
('STARTER','Starter','Plano inicial para pequenos ÃƒÂ³rgÃƒÂ£os e implantaÃƒÂ§ÃƒÂ£o piloto.','MENSAL',0,'BRL','MENSAL',10,1,1024,false,false,true,false,true,10),
('GOV_BASIC','Governo BÃƒÂ¡sico','Plano para secretarias e ÃƒÂ³rgÃƒÂ£os com gestÃƒÂ£o administrativa.','MENSAL',0,'BRL','MENSAL',50,1,10240,true,false,true,true,true,20),
('GOV_PLUS','Governo Plus','Plano completo para prefeituras e estruturas multiÃƒÂ¡reas.','MENSAL',0,'BRL','MENSAL',200,3,51200,true,false,true,true,true,30),
('ENTERPRISE','Enterprise','Plano corporativo com mÃƒÂ³dulos ilimitados e domÃƒÂ­nio personalizado.','MENSAL',0,'BRL','MENSAL',null,null,null,true,true,false,false,true,40)
...
insert into sigov.saas_plano_limite (plano_id,codigo,nome,valor,unidade,ilimitado)
select p.id, 'usuarios', 'UsuÃƒÂ¡rios ativos', p.limite_usuarios, 'usuarios', p.limite_usuarios is null from sigov.saas_plano p
...
('saas','planos','modulos','saas.planos.modulos','Configurar mÃƒÂ³dulos de planos SaaS',true),
('saas','planos','limites','saas.planos.limites','Configurar limites de planos SaaS',true),
('tributario','dashboard','visualizar','tributario.dashboard.visualizar','Visualizar dashboard tributÃƒÂ¡rio',true),
('tributario','configuracao','visualizar','tributario.configuracao.visualizar','Visualizar configuraÃƒÂ§ÃƒÂ£o tributÃƒÂ¡ria',true),
('tributario','configuracao','editar','tributario.configuracao.editar','Editar configuraÃƒÂ§ÃƒÂ£o tributÃƒÂ¡ria',true),
('tributario','tipos','visualizar','tributario.tipos.visualizar','Visualizar tipos tributÃƒÂ¡rios',true),
('tributario','tipos','editar','tributario.tipos.editar','Editar tipos tributÃƒÂ¡rios',true),
('tributario','campos','visualizar','tributario.campos.visualizar','Visualizar campos dinÃƒÂ¢micos tributÃƒÂ¡rios',true),
('tributario','campos','editar','tributario.campos.editar','Editar campos dinÃƒÂ¢micos tributÃƒÂ¡rios',true),
...
('tributario','imoveis','visualizar','tributario.imoveis.visualizar','Visualizar imÃƒÂ³veis',true),
('tributario','imoveis','criar','tributario.imoveis.criar','Criar imÃƒÂ³veis',true),
('tributario','imoveis','editar','tributario.imoveis.editar','Editar imÃƒÂ³veis',true),
('tributario','economicos','visualizar','tributario.economicos.visualizar','Visualizar econÃƒÂ´micos',true),
('tributario','economicos','criar','tributario.economicos.criar','Criar econÃƒÂ´micos',true),
('tributario','economicos','editar','tributario.economicos.editar','Editar econÃƒÂ´micos',true)
on conflict (modulo,recurso,acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;
...
from sigov.tenant t
cross join (values
('orgao.nome',null,'string','Nome do ÃƒÂ³rgÃƒÂ£o',false),
('orgao.documento',null,'string','Documento do ÃƒÂ³rgÃƒÂ£o',false),
('orgao.email',null,'string','E-mail institucional',false),
('orgao.telefone',null,'string','Telefone institucional',false),
('orgao.endereco',null,'string','EndereÃƒÂ§o institucional',false),
('sistema.timezone','America/Sao_Paulo','string','Timezone padrÃƒÂ£o',false),
('sistema.locale','pt-BR','string','Locale padrÃƒÂ£o',false),
('sistema.moeda','BRL','string','Moeda padrÃƒÂ£o',false),
('lgpd.mascara_dados','true','boolean','Aplicar mÃƒÂ¡scara LGPD',false),
('auditoria.retencao_dias','365','number','RetenÃƒÂ§ÃƒÂ£o da auditoria',false)
...
from sigov.tenant t
cross join (values
('CONTRIBUINTE','Contribuinte','Cadastro parametrizÃƒÂ¡vel de contribuintes'),
('IMOVEL','ImÃƒÂ³vel','Cadastro imobiliÃƒÂ¡rio parametrizÃƒÂ¡vel'),
('ECONOMICO','EconÃƒÂ´mico','Cadastro econÃƒÂ´mico/mobiliÃƒÂ¡rio parametrizÃƒÂ¡vel')
) as v(codigo,nome,descricao)
on conflict (tenant_id,codigo) do nothing;
-- >>> database/postgres/migrations/20260610100000_pos_build_04_enterprise_modules.sql
-- SIGOV PÃƒÂ³s-Build 04: base comercial, ordem de serviÃƒÂ§o, manutenÃƒÂ§ÃƒÂ£o industrial, estoque/compras e comÃƒÂ©rcio.
create schema if not exists sigov;
...
insert into sigov.permissao (modulo,recurso,acao,chave,descricao,ativo)
values
('comercial','*','gerenciar','comercial.*','Gerenciar mÃƒÂ³dulo Comercial/CRM',true),
('os','*','gerenciar','os.*','Gerenciar mÃƒÂ³dulo de Ordem de ServiÃƒÂ§o',true),
('industrial','*','gerenciar','industrial.*','Gerenciar mÃƒÂ³dulo de ManutenÃƒÂ§ÃƒÂ£o Industrial',true),
('estoque','*','gerenciar','estoque.*','Gerenciar mÃƒÂ³dulo de Estoque',true),
('compras','*','gerenciar','compras.*','Gerenciar mÃƒÂ³dulo de Compras',true),
('comercio','*','gerenciar','comercio.*','Gerenciar mÃƒÂ³dulo de ComÃƒÂ©rcio',true)
on conflict (modulo,recurso,acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;
-- >>> database/postgres/migrations/20260610120000_pos_build_05_comercio_varejo_atacado_pdv_caixa_financeiro.sql
-- SIGOV PÃƒÂ³s-Build 05: ComÃƒÂ©rcio varejista/atacadista avanÃƒÂ§ado, PDV, caixa, estoque integrado e financeiro inicial.
-- Migration idempotente: CREATE TABLE/INDEX IF NOT EXISTS e seeds com ON CONFLICT, sem remoÃƒÂ§ÃƒÂ£o destrutiva.
create schema if not exists sigov;
...
insert into sigov.permissao (modulo,recurso,acao,chave,descricao,ativo) values
('comercio','dashboard','visualizar','comercio.dashboard.visualizar','Visualizar dashboard comercial avanÃƒÂ§ado',true),
...
('comercio','orcamentos','visualizar','comercio.orcamentos.visualizar','Visualizar orÃƒÂ§amentos',true),
('comercio','orcamentos','criar','comercio.orcamentos.criar','Criar orÃƒÂ§amentos',true),
('comercio','orcamentos','aprovar','comercio.orcamentos.aprovar','Aprovar orÃƒÂ§amentos',true),
...
('comercio','tabelas','visualizar','comercio.tabelas.visualizar','Visualizar tabelas de preÃƒÂ§o',true),
('comercio','tabelas','editar','comercio.tabelas.editar','Editar tabelas de preÃƒÂ§o',true),
('comercio','comissoes','visualizar','comercio.comissoes.visualizar','Visualizar comissÃƒÂµes',true),
('comercio','comissoes','calcular','comercio.comissoes.calcular','Calcular comissÃƒÂµes',true),
...
insert into sigov.tenant_modulo_pacote (codigo, nome, descricao, modulos_json) values
('COMERCIO_STARTER','ComÃƒÂ©rcio Starter','Varejo com PDV, caixa e estoque.','["comercial","comercio_varejo","pdv","caixa","estoque_compras"]'::jsonb),
('COMERCIO_PLUS','ComÃƒÂ©rcio Plus','Varejo e atacado integrados ao estoque e financeiro inicial.','["comercial","comercio_varejo","comercio_atacado","pdv","caixa","estoque_compras","financeiro_empresarial"]'::jsonb),
('ATACADO_PRO','Atacado Pro','Pedidos, separaÃƒÂ§ÃƒÂ£o e financeiro inicial para atacado.','["comercial","comercio_atacado","pedidos","estoque_compras","financeiro_empresarial"]'::jsonb),
('BUSINESS_FULL','Business Full','ComÃƒÂ©rcio, OS, manutenÃƒÂ§ÃƒÂ£o industrial, estoque e financeiro inicial integrados.','["comercial","comercio_varejo","comercio_atacado","pdv","caixa","estoque_compras","ordem_servico","manutencao_industrial","financeiro_empresarial"]'::jsonb)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, modulos_json=excluded.modulos_json, ativo=true;
...
('COMERCIO_STARTER','ComÃƒÂ©rcio Starter','Plano inicial de varejo com PDV, caixa e estoque.','MENSAL',0,'BRL','MENSAL',20,true,true,true,50),
('COMERCIO_PLUS','ComÃƒÂ©rcio Plus','Plano integrado para varejo e atacado com financeiro comercial inicial.','MENSAL',0,'BRL','MENSAL',60,true,true,true,60),
('ATACADO_PRO','Atacado Pro','Plano atacadista com pedidos, separaÃƒÂ§ÃƒÂ£o, estoque e contas a receber.','MENSAL',0,'BRL','MENSAL',80,true,false,true,70),
('BUSINESS_FULL','Business Full','Plano empresarial completo com comÃƒÂ©rcio, OS, manutenÃƒÂ§ÃƒÂ£o, estoque e financeiro inicial.','MENSAL',0,'BRL','MENSAL',200,false,false,true,80)
...
-- SIGOV PÃƒÂ³s-Build 06: IndÃƒÂºstria e ProduÃƒÂ§ÃƒÂ£o avanÃƒÂ§ada, chÃƒÂ£o de fÃƒÂ¡brica e integraÃƒÂ§ÃƒÂµes.
-- Migration idempotente: CREATE TABLE/INDEX IF NOT EXISTS e seeds com ON CONFLICT, sem remoÃƒÂ§ÃƒÂ£o destrutiva.
create schema if not exists sigov;
create extension if not exists pgcrypto;
...
('industria_producao','IndÃƒÂºstria e ProduÃƒÂ§ÃƒÂ£o','ProduÃƒÂ§ÃƒÂ£o por ordem, BOM, roteiro, chÃƒÂ£o de fÃƒÂ¡brica, qualidade e custos.','EMPRESARIAL',true),
('manutencao_industrial','ManutenÃƒÂ§ÃƒÂ£o Industrial','Ativos, planos e manutenÃƒÂ§ÃƒÂ£o industrial integrada.','EMPRESARIAL',true),
('ordem_servico','Ordem de ServiÃƒÂ§o','Ordens de serviÃƒÂ§o tÃƒÂ©cnicas e operacionais.','EMPRESARIAL',true),
...
('comercio_varejo','ComÃƒÂ©rcio Varejo','Varejo, balcÃƒÂ£o e operaÃƒÂ§ÃƒÂµes de loja.','EMPRESARIAL',true),
('comercio_atacado','ComÃƒÂ©rcio Atacado','Pedidos, tabelas e separaÃƒÂ§ÃƒÂ£o atacadista.','EMPRESARIAL',true),
...
insert into sigov.tenant_modulo_pacote (codigo, nome, descricao, modulos_json) values
('INDUSTRIAL_STARTER','Industrial Starter','ProduÃƒÂ§ÃƒÂ£o, estoque e ordem de serviÃƒÂ§o para iniciar operaÃƒÂ§ÃƒÂ£o industrial.','["industria_producao","estoque_compras","ordem_servico"]'::jsonb),
('INDUSTRIAL_PLUS','Industrial Plus','ProduÃƒÂ§ÃƒÂ£o integrada a manutenÃƒÂ§ÃƒÂ£o, OS, compras, estoque e financeiro.','["industria_producao","manutencao_industrial","ordem_servico","estoque_compras","compras","financeiro_empresarial"]'::jsonb),
('FACTORY_FULL','Factory Full','Pacote fabril completo com comercial atacadista, produÃƒÂ§ÃƒÂ£o, estoque e financeiro.','["industria_producao","manutencao_industrial","ordem_servico","estoque_compras","comercial","comercio_atacado","financeiro_empresarial"]'::jsonb),
('BUSINESS_FULL','Business Full','Pacote empresarial completo com comÃƒÂ©rcio, produÃƒÂ§ÃƒÂ£o, OS, manutenÃƒÂ§ÃƒÂ£o, estoque e financeiro.','["comercial","comercio_varejo","comercio_atacado","pdv","caixa","estoque_compras","ordem_servico","manutencao_industrial","industria_producao","financeiro_empresarial"]'::jsonb)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, modulos_json=excluded.modulos_json, ativo=true;

insert into sigov.saas_plano (codigo,nome,descricao,tipo_plano,preco_base,moeda,periodicidade,limite_usuarios,publico,destaque,ativo,ordem) values
('INDUSTRIAL_STARTER','Industrial Starter','IndÃƒÂºstria por ordem com estoque e OS.','MENSAL',0,'BRL','MENSAL',40,true,true,true,90),
('INDUSTRIAL_PLUS','Industrial Plus','IndÃƒÂºstria integrada com manutenÃƒÂ§ÃƒÂ£o, compras e financeiro.','MENSAL',0,'BRL','MENSAL',120,true,true,true,100),
('FACTORY_FULL','Factory Full','OperaÃƒÂ§ÃƒÂ£o fabril e comercial atacadista completa.','MENSAL',0,'BRL','MENSAL',180,true,false,true,110),
('BUSINESS_FULL','Business Full','Empresa completa: comercial, estoque, OS, manutenÃƒÂ§ÃƒÂ£o, indÃƒÂºstria e financeiro.','MENSAL',0,'BRL','MENSAL',250,false,false,true,120)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, limite_usuarios=excluded.limite_usuarios, publico=excluded.publico, destaque=excluded.destaque, ativo=true, updated_at=now();
...
('Gerente Industrial','Gerencia produÃƒÂ§ÃƒÂ£o, chÃƒÂ£o de fÃƒÂ¡brica, custos e indicadores.','GERENTE_INDUSTRIAL',true),
('PCP','Planeja e libera ordens de produÃƒÂ§ÃƒÂ£o.','PCP',true),
('Operador de ProduÃƒÂ§ÃƒÂ£o','Realiza apontamentos de chÃƒÂ£o de fÃƒÂ¡brica.','OPERADOR_PRODUCAO',true),
('Qualidade','Executa inspeÃƒÂ§ÃƒÂµes e liberaÃƒÂ§ÃƒÂµes de qualidade.','QUALIDADE',true),
('ManutenÃƒÂ§ÃƒÂ£o','Atua em paradas e OS de manutenÃƒÂ§ÃƒÂ£o.','MANUTENCAO',true)
on conflict do nothing;
...
('industria','fichas','visualizar','industria.fichas.visualizar','Visualizar fichas tÃƒÂ©cnicas',true),
('industria','fichas','criar','industria.fichas.criar','Criar fichas tÃƒÂ©cnicas',true),
('industria','fichas','editar','industria.fichas.editar','Editar fichas tÃƒÂ©cnicas',true),
...
('industria','ordens','visualizar','industria.ordens.visualizar','Visualizar ordens de produÃƒÂ§ÃƒÂ£o',true),
('industria','ordens','criar','industria.ordens.criar','Criar ordens de produÃƒÂ§ÃƒÂ£o',true),
('industria','ordens','liberar','industria.ordens.liberar','Liberar ordens de produÃƒÂ§ÃƒÂ£o',true),
('industria','ordens','iniciar','industria.ordens.iniciar','Iniciar ordens de produÃƒÂ§ÃƒÂ£o',true),
('industria','ordens','concluir','industria.ordens.concluir','Concluir ordens de produÃƒÂ§ÃƒÂ£o',true),
...
('industria','producao','registrar','industria.producao.registrar','Registrar produÃƒÂ§ÃƒÂ£o acabada',true),
...
('industria','chao_fabrica','acessar','industria.chao_fabrica.acessar','Acessar chÃƒÂ£o de fÃƒÂ¡brica',true)
on conflict (modulo,recurso,acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;
...
('financeiro_empresarial','Financeiro Empresarial','Plano de contas, centros de custo, contas, baixas, movimentos, fluxo de caixa e conciliaÃƒÂ§ÃƒÂ£o.','GestÃƒÂ£o empresarial',45,'/Financeiro/Dashboard','bi-bank',true),
('financeiro_publico','Financeiro PÃƒÂºblico','Base futura para SIAFIC e financeiro pÃƒÂºblico integrado.','GestÃƒÂ£o pÃƒÂºblica',46,'/Financeiro/Dashboard','bi-building-lock',true)
...
-- SIGOV - EvoluÃƒÂ§ÃƒÂ£o PÃƒÂ³s-Build 08: TributÃƒÂ¡rio AvanÃƒÂ§ado e Fiscal Integrado
...
insert into sigov.permissao (modulo,recurso,acao,chave,descricao,ativo) values
('tributario','dashboard','visualizar','tributario.dashboard.visualizar','Visualizar dashboard tributÃƒÂ¡rio avanÃƒÂ§ado',true),
...
('tributario','divida_ativa','visualizar','tributario.divida_ativa.visualizar','Visualizar dÃƒÂ­vida ativa',true),
('tributario','divida_ativa','editar','tributario.divida_ativa.editar','Editar dÃƒÂ­vida ativa',true),
('tributario','parcelamento','visualizar','tributario.parcelamento.visualizar','Visualizar parcelamentos tributÃƒÂ¡rios',true),
('tributario','parcelamento','editar','tributario.parcelamento.editar','Editar parcelamentos tributÃƒÂ¡rios',true),
('tributario','arrecadacao','visualizar','tributario.arrecadacao.visualizar','Visualizar arrecadaÃƒÂ§ÃƒÂ£o tributÃƒÂ¡ria',true),
('tributario','arrecadacao','registrar','tributario.arrecadacao.registrar','Registrar arrecadaÃƒÂ§ÃƒÂ£o tributÃƒÂ¡ria',true),
...
('tributario','livro_eletronico','visualizar','tributario.livro_eletronico.visualizar','Visualizar livro eletrÃƒÂ´nico tributÃƒÂ¡rio',true),
('tributario','livro_eletronico','gerar','tributario.livro_eletronico.gerar','Gerar livro eletrÃƒÂ´nico tributÃƒÂ¡rio',true)
on conflict (modulo,recurso,acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;

insert into sigov.perfil_acesso (nome, descricao, codigo_externo, ativo) values
('TributÃƒÂ¡rio Admin','Administra IPTU, ISS, taxas, DAM, dÃƒÂ­vida ativa, NFS-e simulada e livro eletrÃƒÂ´nico.','TRIBUTARIO_ADMIN',true),
('Fiscal TributÃƒÂ¡rio','Opera lanÃƒÂ§amentos, arrecadaÃƒÂ§ÃƒÂ£o, parcelamentos e relatÃƒÂ³rios fiscais.','FISCAL_TRIBUTARIO',true),
('Consulta TributÃƒÂ¡ria','Consulta dashboard, livro eletrÃƒÂ´nico e relatÃƒÂ³rios fiscais.','CONSULTA_TRIBUTARIA',true)
on conflict do nothing;
...
insert into sigov.tenant_modulo_pacote (codigo, nome, descricao, modulos_json) values
('GOV_TRIBUTARIO_PLUS','Gov TributÃƒÂ¡rio Plus','Pacote fiscal municipal com TributÃƒÂ¡rio AvanÃƒÂ§ado, Financeiro PÃƒÂºblico e LGPD.', '["tributario","financeiro_publico","auditoria-lgpd"]'::jsonb)
...
from sigov.tenant t
cross join (values
    ('IPTU','Imposto Predial e Territorial Urbano','IPTU',1.0000,'CÃƒÂ³digo TributÃƒÂ¡rio Municipal - IPTU','IMOBILIARIO'),
    ('ISS','Imposto Sobre ServiÃƒÂ§os','ISS',2.0000,'CÃƒÂ³digo TributÃƒÂ¡rio Municipal - ISS','SERVICO'),
    ('TAXA_COLETA','Taxa de Coleta de ResÃƒÂ­duos','TAXA',0.0000,'CÃƒÂ³digo TributÃƒÂ¡rio Municipal - Taxas','SERVICO')
...
-- SIGOV PLUS - PÃƒÂ³s-Build 09: GED/OCR, assinatura digital simulada e automaÃƒÂ§ÃƒÂ£o documental.
...
('ged','tramitacao','tramitar','ged.tramitar','Tramitar documentos e protocolos eletrÃƒÂ´nicos.',true),
('contrato','contrato','visualizar','contrato.visualizar','Visualizar contratos jurÃƒÂ­dicos e comerciais.',true),
...
from sigov.tenant t
cross join (values
    ('CONTRATO','Contrato','Instrumentos jurÃƒÂ­dicos, comerciais e administrativos.',true,true,'["numero","vigencia","contratado"]'),
    ('DOCUMENTO_FISCAL','Documento fiscal','Notas, DAM, comprovantes e livros fiscais vinculados ao TributÃƒÂ¡rio.',false,true,'["competencia","valor","origem"]'),
    ('CHECKLIST_PRODUCAO','Checklist de produÃƒÂ§ÃƒÂ£o','Checklist, qualidade e evidÃƒÂªncias de ordens industriais.',false,true,'["ordem","produto","etapa"]'),
    ('PROTOCOLO','Protocolo eletrÃƒÂ´nico','Documentos recebidos via protocolo e atendimento.',false,true,'["numero_protocolo","canal"]')
...
from sigov.tenant t
cross join (values
    ('TPL_CONTRATO_PADRAO','Contrato padrÃƒÂ£o','CONTRATO','Contrato nÃ‚Âº {{numero}} firmado com {{contratado}} no valor de {{valor_total}}.','["numero","contratado","valor_total"]'),
    ...
    ('TPL_CHECKLIST_OP','Checklist de ordem de produÃƒÂ§ÃƒÂ£o','CHECKLIST_PRODUCAO','Checklist da ordem {{ordem}} para produto {{produto}} na etapa {{etapa}}.','["ordem","produto","etapa"]')
...
select t.id, 'WF_GED_BASICO', 'Workflow bÃƒÂ¡sico GED/OCR/Assinatura', 'RECEBIMENTO', 'ATIVO', '{"etapas":["RECEBIMENTO","OCR","INDEXACAO","TRAMITACAO","ASSINATURA","ARQUIVAMENTO"],"assinatura":"SIMULADA"}'::jsonb
from sigov.tenant t
where t.slug in ('plataforma-global','prefeitura-demo','tenant-demo')
...
insert into sigov.tenant_modulo_pacote (codigo, nome, descricao, modulos_json) values
('GED_AUTOMACAO_PLUS','GED AutomaÃƒÂ§ÃƒÂ£o Plus','GED completo com OCR simulado, contratos, protocolos, workflow, tramitaÃƒÂ§ÃƒÂ£o e assinatura digital simulada.', '["ged","ocr","contrato","fluxo","processos","integracoes","auditoria-lgpd"]'::jsonb)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, modulos_json=excluded.modulos_json;
...
-- PÃƒÂ³s-Build 11: IA, automaÃƒÂ§ÃƒÂ£o inteligente, assistentes operacionais e anÃƒÂ¡lise preditiva
...
('INTERNO','Provider interno heurÃƒÂ­stico','INTERNO',null,true),
('LOCAL','Provider local configurÃƒÂ¡vel','LOCAL',null,true),
('OPENAI','OpenAI configurÃƒÂ¡vel','OPENAI',null,false),
('AZURE_OPENAI','Azure OpenAI configurÃƒÂ¡vel','AZURE_OPENAI',null,false)
...
('ASSISTENTE_TRIBUTARIO','Assistente TributÃƒÂ¡rio','Apoio a anÃƒÂ¡lises fiscais e arrecadaÃƒÂ§ÃƒÂ£o.','TRIBUTARIO',true),
('ASSISTENTE_FINANCEIRO','Assistente Financeiro','Apoio a fluxo de caixa, cobranÃƒÂ§a e inadimplÃƒÂªncia.','FINANCEIRO',true),
('ASSISTENTE_GED','Assistente GED','Resumo, classificaÃƒÂ§ÃƒÂ£o e extraÃƒÂ§ÃƒÂ£o documental.','GED',true),
('ASSISTENTE_COMERCIAL','Assistente Comercial','Apoio a clientes, leads e oportunidades.','COMERCIAL',true),
('ASSISTENTE_INDUSTRIA','Assistente IndÃƒÂºstria','Apoio ao chÃƒÂ£o de fÃƒÂ¡brica e produÃƒÂ§ÃƒÂ£o.','INDUSTRIA',true),
('ASSISTENTE_OS','Assistente OS','Apoio a ordens de serviÃƒÂ§o.','OS',true),
('ASSISTENTE_JURIDICO','Assistente JurÃƒÂ­dico','GeraÃƒÂ§ÃƒÂ£o assistida de pareceres.','JURIDICO',true),
...
(null,'resumo_processo','Resumo de processo','protocolo','RESUMO','Resuma o processo e sugira prÃƒÂ³ximos passos sem executar aÃƒÂ§ÃƒÂµes crÃƒÂ­ticas.',false,true),
(null,'resumo_os','Resumo de OS','ordem_servico','RESUMO','Resuma o histÃƒÂ³rico da OS e a prÃƒÂ³xima aÃƒÂ§ÃƒÂ£o segura.',false,true),
(null,'resumo_contrato','Resumo de contrato','contrato','RESUMO','Resuma contrato, vigÃƒÂªncia, clÃƒÂ¡usulas e riscos.',false,true),
(null,'classificar_documento','Classificar documento','ged','CLASSIFICACAO','Classifique por palavras-chave e indique confianÃƒÂ§a.',false,true),
(null,'extrair_dados_documento','Extrair dados de documento','ged','EXTRACAO','Extraia nÃƒÂºmero, datas, valores e partes, mascarando dados sensÃƒÂ­veis.',false,true),
(null,'gerar_relatorio_financeiro','Gerar relatÃƒÂ³rio financeiro','financeiro_empresarial','RELATORIO','Gere relatÃƒÂ³rio textual financeiro com riscos e oportunidades.',false,true),
(null,'gerar_parecer_juridico','Gerar parecer jurÃƒÂ­dico','juridico','PARECER','Rascunhe parecer para revisÃƒÂ£o humana obrigatÃƒÂ³ria.',true,true),
(null,'gerar_despacho_protocolo','Gerar despacho de protocolo','protocolo','DESPACHO','Rascunhe despacho administrativo para revisÃƒÂ£o humana.',true,true),
(null,'sugerir_acoes_cobranca','Sugerir aÃƒÂ§ÃƒÂµes de cobranÃƒÂ§a','financeiro_empresarial','SUGESTAO','Sugira aÃƒÂ§ÃƒÂµes de cobranÃƒÂ§a sem baixa financeira automÃƒÂ¡tica.',true,true),
(null,'prever_inadimplencia','Prever inadimplÃƒÂªncia','financeiro_empresarial','ANALISE','Estime risco de inadimplÃƒÂªncia por regras.',false,true),
(null,'prever_atraso_os','Prever atraso OS','ordem_servico','ANALISE','Estime risco de atraso em OS.',false,true),
(null,'prever_ruptura_estoque','Prever ruptura estoque','estoque_compras','ANALISE','Estime risco de ruptura por saldo e estoque mÃƒÂ­nimo.',false,true),
(null,'sugerir_reposicao_estoque','Sugerir reposiÃƒÂ§ÃƒÂ£o','estoque_compras','SUGESTAO','Sugira compra/reposiÃƒÂ§ÃƒÂ£o com confirmaÃƒÂ§ÃƒÂ£o humana.',true,true),
(null,'analisar_fluxo_caixa','Analisar fluxo de caixa','financeiro_empresarial','ANALISE','Analise tendÃƒÂªncias e alertas no fluxo de caixa.',false,true),
(null,'analisar_producao_atrasada','Analisar produÃƒÂ§ÃƒÂ£o atrasada','industria_producao','ANALISE','Identifique risco e causa provÃƒÂ¡vel de atraso produtivo.',false,true)
...
('inadimplencia_cliente','InadimplÃƒÂªncia de cliente','Modelo heurÃƒÂ­stico inicial.','financeiro_empresarial','INADIMPLENCIA',true),
('atraso_ordem_servico','Atraso em ordem de serviÃƒÂ§o','Modelo heurÃƒÂ­stico inicial.','ordem_servico','ATRASO_OS',true),
('ruptura_estoque','Ruptura de estoque','Modelo heurÃƒÂ­stico inicial.','estoque_compras','ESTOQUE_RUPTURA',true),
('risco_contrato','Risco contratual','Modelo heurÃƒÂ­stico inicial.','contrato','CONTRATO_RISCO',true),
('atraso_producao','Atraso de produÃƒÂ§ÃƒÂ£o','Modelo heurÃƒÂ­stico inicial.','industria_producao','PRODUCAO_ATRASO',true),
('queda_arrecadacao','Queda de arrecadaÃƒÂ§ÃƒÂ£o','Modelo heurÃƒÂ­stico inicial.','tributario','ARRECADACAO',true),
('churn_saas','Churn SaaS','Modelo heurÃƒÂ­stico inicial.','operacao-saas','CHURN',true)
...
insert into sigov.modulo_saas(codigo,nome,descricao,categoria,ordem,rota_base,icone,ativo) values
('ia_assistente','IA Assistente','Assistentes inteligentes por mÃƒÂ³dulo, seguros e auditÃƒÂ¡veis.','InteligÃƒÂªncia',900,'/IA/Assistente','bi-robot',true),
('ia_documental','IA Documental','Resumo, classificaÃƒÂ§ÃƒÂ£o e extraÃƒÂ§ÃƒÂ£o estruturada de documentos.','InteligÃƒÂªncia',901,'/IA/Documental','bi-file-earmark-text',true),
('ia_relatorios','IA RelatÃƒÂ³rios','GeraÃƒÂ§ÃƒÂ£o assistida de relatÃƒÂ³rios textuais.','InteligÃƒÂªncia',902,'/IA/Relatorios','bi-bar-chart-line',true),
('ia_automacoes','IA AutomaÃƒÂ§ÃƒÂµes','SugestÃƒÂµes, alertas e workflows com confirmaÃƒÂ§ÃƒÂ£o humana.','InteligÃƒÂªncia',903,'/IA/Automacoes','bi-diagram-3',true),
('ia_predicoes','IA PrediÃƒÂ§ÃƒÂµes','AnÃƒÂ¡lise preditiva inicial baseada em regras.','InteligÃƒÂªncia',904,'/IA/Predicoes','bi-graph-up-arrow',true)
...
('ia_1000_interacoes','IA 1.000 interaÃƒÂ§ÃƒÂµes','Pacote mensal adicional de 1.000 interaÃƒÂ§ÃƒÂµes de IA.','IA_CONSUMO','ia_assistente',null,'MENSAL'),
('ia_10000_interacoes','IA 10.000 interaÃƒÂ§ÃƒÂµes','Pacote mensal adicional de 10.000 interaÃƒÂ§ÃƒÂµes de IA.','IA_CONSUMO','ia_assistente',null,'MENSAL'),
('ia_ocr_avancado','IA OCR avanÃƒÂ§ado','Capacidades avanÃƒÂ§adas de OCR e extraÃƒÂ§ÃƒÂ£o.','IA_RECURSO','ia_documental',null,'MENSAL'),
('ia_relatorios_avancados','IA relatÃƒÂ³rios avanÃƒÂ§ados','RelatÃƒÂ³rios assistidos avanÃƒÂ§ados.','IA_RECURSO','ia_relatorios',null,'MENSAL'),
('ia_automacoes_avancadas','IA automaÃƒÂ§ÃƒÂµes avanÃƒÂ§adas','Workflows inteligentes avanÃƒÂ§ados.','IA_RECURSO','ia_automacoes',null,'MENSAL')
on conflict(codigo) do update set nome=excluded.nome,descricao=excluded.descricao,tipo_addon=excluded.tipo_addon,modulo_codigo=excluded.modulo_codigo;

insert into sigov.tenant_modulo_pacote(codigo,nome,descricao,modulos_json) values
('AI_STARTER','AI Starter','Assistente e relatÃƒÂ³rios por IA.','["ia_assistente","ia_relatorios"]'::jsonb),
...
('GOV_FULL_AI','Gov Full AI','Governo com IA documental, relatÃƒÂ³rios e automaÃƒÂ§ÃƒÂµes.','["tributario","protocolo","ged","contratos","financeiro_publico","ia_assistente","ia_documental","ia_relatorios","ia_automacoes"]'::jsonb)
on conflict(codigo) do update set nome=excluded.nome,descricao=excluded.descricao,modulos_json=excluded.modulos_json;
...
('ia','execucoes','visualizar','ia.execucoes.visualizar','Visualizar execuÃƒÂ§ÃƒÂµes IA',true),
('ia','sugestoes','visualizar','ia.sugestoes.visualizar','Visualizar sugestÃƒÂµes IA',true),
('ia','sugestoes','aprovar','ia.sugestoes.aprovar','Aprovar sugestÃƒÂµes IA',true),
('ia','sugestoes','aplicar','ia.sugestoes.aplicar','Aplicar sugestÃƒÂµes IA',true),
('ia','sugestoes','rejeitar','ia.sugestoes.rejeitar','Rejeitar sugestÃƒÂµes IA',true),
...
('ia','relatorios','gerar','ia.relatorios.gerar','Gerar relatÃƒÂ³rios por IA',true),
('ia','automacoes','visualizar','ia.automacoes.visualizar','Visualizar automaÃƒÂ§ÃƒÂµes IA',true),
('ia','automacoes','criar','ia.automacoes.criar','Criar automaÃƒÂ§ÃƒÂµes IA',true),
('ia','automacoes','editar','ia.automacoes.editar','Editar automaÃƒÂ§ÃƒÂµes IA',true),
('ia','automacoes','executar','ia.automacoes.executar','Executar automaÃƒÂ§ÃƒÂµes IA',true),
...
('ia','predicoes','visualizar','ia.predicoes.visualizar','Visualizar prediÃƒÂ§ÃƒÂµes IA',true),
('ia','predicoes','executar','ia.predicoes.executar','Executar prediÃƒÂ§ÃƒÂµes IA',true),
('ia','configuracao','visualizar','ia.configuracao.visualizar','Visualizar configuraÃƒÂ§ÃƒÂ£o IA',true),
('ia','configuracao','editar','ia.configuracao.editar','Editar configuraÃƒÂ§ÃƒÂ£o IA',true),
...
-- SIGOV PÃƒÂ³s-Build 12: Mobile/PWA, Campo, Offline First, Georreferenciamento e SincronizaÃƒÂ§ÃƒÂ£o
create schema if not exists sigov;
...
create table if not exists sigov.campo_localizacao (
  ...
  regra_operacional text not null default 'Coleta opcional conforme permissÃƒÂ£o e finalidade operacional.',
  capturado_at timestamptz not null default now(),
  created_at timestamptz not null default now()
);
...
(1,'checklist_os_tecnica','Checklist OS TÃƒÂ©cnica','ordem_servico','ORDEM_SERVICO'),
(1,'checklist_visita_social','Checklist Visita Social','social','VISITA'),
(1,'checklist_visita_acs','Checklist Visita ACS','saude','VISITA'),
(1,'checklist_leitura_hidrometro','Checklist Leitura de HidrÃƒÂ´metro','saneamento','LEITURA'),
(1,'checklist_vistoria_tributaria','Checklist Vistoria TributÃƒÂ¡ria','tributario','FISCALIZACAO'),
(1,'checklist_visita_agro','Checklist Visita Agro','agro','VISITA'),
(1,'checklist_manutencao_industrial','Checklist ManutenÃƒÂ§ÃƒÂ£o Industrial','manutencao_industrial','MANUTENCAO'),
...
join (values
('checklist_os_tecnica','seguranca','Checklist de seguranÃƒÂ§a preenchido?','SIM_NAO',true,1),
...
('checklist_visita_acs','domicilio','DomicÃƒÂ­lio visitado?','SIM_NAO',true,1),
...
(1,'Mobile/PWA habilitado','Ambiente mobile, offline sync e campo operacional disponÃƒÂ­veis para demonstraÃƒÂ§ÃƒÂ£o.','INFO',true)
on conflict do nothing;

-- Tokens/seeds pesquisÃƒÂ¡veis pelo script completo/testes estÃƒÂ¡ticos: mobile_usuarios_extra, storage_fotos_campo, geolocalizacao_avancada, sincronizacao_offline_avancada,
