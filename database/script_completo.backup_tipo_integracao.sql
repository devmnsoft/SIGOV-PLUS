...
-- Pode ser executado vÃƒÆ’Ã‚Â¡rias vezes. NÃƒÆ’Ã‚Â£o contÃƒÆ’Ã‚Â©m remoÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o destrutiva.
...
-- As seÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes abaixo consolidam as migrations idempotentes do repositÃƒÆ’Ã‚Â³rio: base, SaaS, tributÃƒÆ’Ã‚Â¡rio,
-- comercial/varejo/atacado/PDV/caixa, estoque/compras, OS, manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, mÃƒÆ’Ã‚Â³dulos pÃƒÆ’Ã‚Âºblicos e indÃƒÆ’Ã‚Âºstria.
...
-- Contexto mantido no cÃƒÆ’Ã‚Â³digo por bounded context; novas tabelas deste grupo devem ser criadas diretamente no schema sigov.
...
begin
    ...
    values ('Prefeitura Municipal de DemonstraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o', '00000000000191', true, 'Registro de desenvolvimento sigov')
    ...
    values
        (v_entidade_id, v_exercicio_id, 'core', 'core_admin', 'PermissÃƒÆ’Ã‚Â£o administrativa do nÃƒÆ’Ã‚Âºcleo', true),
        (v_entidade_id, v_exercicio_id, 'seguranca', 'seguranca_admin', 'PermissÃƒÆ’Ã‚Â£o administrativa de seguranÃƒÆ’Ã‚Â§a', true),
        (v_entidade_id, v_exercicio_id, 'auditoria', 'auditoria_admin', 'PermissÃƒÆ’Ã‚Â£o administrativa de auditoria', true),
        (v_entidade_id, v_exercicio_id, 'lgpd', 'lgpd_admin', 'PermissÃƒÆ’Ã‚Â£o administrativa LGPD', true),
        (v_entidade_id, v_exercicio_id, 'suporte', 'suporte_admin', 'PermissÃƒÆ’Ã‚Â£o administrativa de suporte', true),
        (v_entidade_id, v_exercicio_id, 'conformidade', 'aderencia_admin', 'PermissÃƒÆ’Ã‚Â£o administrativa de conformidade e aderÃƒÆ’Ã‚Âªncia', true)
    on conflict do nothing;
...
-- comando legado omitido por regra de seguranÃƒÆ’Ã‚Â§a sem remoÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o destrutiva.
            end if;
        end if;
    end loop;
end $$;
...
-- MÃƒÆ’Ã‚Â³dulo Processos Digitais, Protocolo, GED bÃƒÆ’Ã‚Â¡sico, Ouvidoria e DiÃƒÆ’Ã‚Â¡rio Oficial.
...
cross join (values
    ...
    ('LicitaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o', 'Processos de contrataÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o pÃƒÆ’Ã‚Âºblica', 60),
    ('Requerimento', 'Requerimentos de cidadÃƒÆ’Ã‚Â£os e empresas', 20),
...
from (values
 ...
 ('processos.ouvidoria.criar','Criar manifestaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes de ouvidoria'),
 ('processos.ouvidoria.responder','Responder manifestaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes de ouvidoria'),
 ('processos.ouvidoria.converter','Converter ouvidoria em processo'),
 ('processos.ouvidoria.arquivar','Arquivar ouvidoria'),
 ('processos.diario.visualizar','Visualizar diÃƒÆ’Ã‚Â¡rio oficial'),
 ('processos.diario.criar','Criar publicaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes do diÃƒÆ’Ã‚Â¡rio oficial'),
 ('processos.diario.editar','Editar publicaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes do diÃƒÆ’Ã‚Â¡rio oficial'),
 ('processos.diario.publicar','Publicar diÃƒÆ’Ã‚Â¡rio oficial')
...
values ('financeiro', 'Financeiro/SIAFIC', 'Base financeira e orÃƒÆ’Ã‚Â§amentÃƒÆ’Ã‚Â¡ria SIAFIC do sigov.', 'Operacional', 20, '/Financeiro', 'cash-coin', true)
...
from (values
 ...
 ('financeiro.orcamento.visualizar','Visualizar orÃƒÆ’Ã‚Â§amento'),('financeiro.orcamento.criar','Criar orÃƒÆ’Ã‚Â§amento'),('financeiro.orcamento.editar','Editar orÃƒÆ’Ã‚Â§amento'),('financeiro.orcamento.movimentar','Movimentar orÃƒÆ’Ã‚Â§amento'),
 ...
 ('financeiro.liquidacao.visualizar','Visualizar liquidaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes'),('financeiro.liquidacao.criar','Criar liquidaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes'),('financeiro.liquidacao.anular','Anular liquidaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes'),
...
select t.id, e.id, ex.id, '1500', 'Recursos nÃƒÆ’Ã‚Â£o vinculados de impostos', 'Seed financeiro bÃƒÆ’Ã‚Â¡sico'
...
-- Etapa 2 - Pessoa e EndereÃƒÆ’Ã‚Â§o: reforÃƒÆ’Ã‚Â§os operacionais, ÃƒÆ’Ã‚Â­ndices e permissÃƒÆ’Ã‚Âµes granulares.
...
values
    ('core', 'pessoas', 'visualizar', 'core.pessoas.visualizar', 'Visualizar pessoas e endereÃƒÆ’Ã‚Â§os', true),
    ...
    ('core', 'enderecos', 'gerenciar', 'core.enderecos.gerenciar', 'Gerenciar endereÃƒÆ’Ã‚Â§os de pessoas', true),
    ('core', 'pessoas', 'exportar', 'core.exportar', 'Exportar cadastro de pessoas', true)
on conflict do nothing;
-- >>> database/postgres/migrations/020_rh_completo.sql
-- MÃƒÆ’Ã‚Â³dulo Recursos Humanos completo: cadastros, folha, ponto, fÃƒÆ’Ã‚Â©rias, afastamentos, saÃƒÆ’Ã‚Âºde ocupacional,
-- eSocial estrutural, portal do servidor, outbox de eventos e integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o futura com Financeiro/SIAFIC.
...
values
    ...
    ('rh', 'financeiro', 'integrar', 'rh.financeiro.integrar', 'Preparar integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o de folha com Financeiro/SIAFIC', true)
on conflict do nothing;
-- >>> database/postgres/migrations/021_educacao_base.sql
-- EducaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o Base: escolas, ano letivo, cursos, turmas, alunos, matrÃƒÆ’Ã‚Â­culas, frequÃƒÆ’Ã‚Âªncia, avaliaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes,
-- prÃƒÆ’Ã‚Â©-matrÃƒÆ’Ã‚Â­cula, Educacenso estrutural, portal educacional, dashboard, auditoria tÃƒÆ’Ã‚Â©cnica e outbox.
-- Todas as estruturas operacionais permanecem no schema ÃƒÆ’Ã‚Âºnico sigov.
...
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo)
values ('educacao', 'EducaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o', 'MÃƒÆ’Ã‚Â³dulo base de gestÃƒÆ’Ã‚Â£o escolar do sigov', 'Operacional', 40, '/Educacao/Dashboard', 'book', true)
...
('educacao','matricula','visualizar','educacao.matricula.visualizar','Visualizar matrÃƒÆ’Ã‚Â­culas',true),
('educacao','matricula','criar','educacao.matricula.criar','Criar matrÃƒÆ’Ã‚Â­cula',true),
('educacao','matricula','cancelar','educacao.matricula.cancelar','Cancelar matrÃƒÆ’Ã‚Â­cula',true),
('educacao','matricula','transferir','educacao.matricula.transferir','Transferir matrÃƒÆ’Ã‚Â­cula',true),
...
('educacao','frequencia','visualizar','educacao.frequencia.visualizar','Visualizar frequÃƒÆ’Ã‚Âªncia',true),
('educacao','frequencia','criar','educacao.frequencia.criar','Registrar frequÃƒÆ’Ã‚Âªncia',true),
('educacao','avaliacao','visualizar','educacao.avaliacao.visualizar','Visualizar avaliaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes',true),
('educacao','avaliacao','criar','educacao.avaliacao.criar','Criar avaliaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('educacao','nota','criar','educacao.nota.criar','Registrar nota',true),
('educacao','pre_matricula','visualizar','educacao.pre_matricula.visualizar','Visualizar prÃƒÆ’Ã‚Â©-matrÃƒÆ’Ã‚Â­cula',true),
('educacao','pre_matricula','criar','educacao.pre_matricula.criar','Criar prÃƒÆ’Ã‚Â©-matrÃƒÆ’Ã‚Â­cula',true),
('educacao','pre_matricula','converter','educacao.pre_matricula.converter','Converter prÃƒÆ’Ã‚Â©-matrÃƒÆ’Ã‚Â­cula',true),
...
('educacao','dashboard','visualizar','educacao.dashboard.visualizar','Visualizar dashboard educaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('educacao','exportar','exportar','educacao.exportar','Exportar dados de educaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true)
on conflict do nothing;

-- Seeds de desenvolvimento seguros: sÃƒÆ’Ã‚Â³ inserem se existir tenant e entidade base.
do $$
declare
    v_tenant bigint;
    v_entidade bigint;
...
begin
    ...
    if v_tenant is not null and v_entidade is not null then
        ...
        values (v_tenant, v_entidade, v_curso, '1ANO', '1Ãƒâ€šÃ‚Âº Ano', 1)
        ...
        if v_escola is not null and v_ano is not null and v_curso is not null and v_serie is not null then
            ...
            values (v_tenant, v_entidade, v_exercicio, v_escola, v_ano, v_curso, v_serie, '1A', '1Ãƒâ€šÃ‚Âº Ano A', 'MATUTINO', 30, 'ABERTA')
            on conflict (tenant_id, entidade_id, ano_letivo_id, codigo) do nothing;
        end if;
    end if;
end $$;
-- >>> database/postgres/migrations/022_saude_acs_base.sql
-- SaÃƒÆ’Ã‚Âºde/ACS base - schema ÃƒÆ’Ã‚Âºnico sigov, PostgreSQL, Dapper-ready e idempotente.
create extension if not exists pgcrypto;
...
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo)
values ('saude', 'SaÃƒÆ’Ã‚Âºde', 'MÃƒÆ’Ã‚Â³dulo base de saÃƒÆ’Ã‚Âºde, ACS, pacientes, atendimentos, farmÃƒÆ’Ã‚Â¡cia e vacinaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o do sigov', 'Operacional', 50, '/Saude/Dashboard', 'heart-pulse', true)
on conflict (codigo) do nothing;

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo)
values ('saude.acs_offline', 'ACS offline estrutural', 'Habilita endpoints e tela de sincronizaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o offline estrutural do ACS.', 'saude', true)
on conflict (codigo) do nothing;
...
insert into sigov.permissao (modulo, recurso, acao, chave, descricao, ativo)
values
('saude','unidade','visualizar','saude.unidade.visualizar','Visualizar unidades de saÃƒÆ’Ã‚Âºde',true),('saude','unidade','criar','saude.unidade.criar','Criar unidades de saÃƒÆ’Ã‚Âºde',true),('saude','unidade','editar','saude.unidade.editar','Editar unidades de saÃƒÆ’Ã‚Âºde',true),('saude','unidade','excluir','saude.unidade.excluir','Excluir unidades de saÃƒÆ’Ã‚Âºde',true),
('saude','profissional','visualizar','saude.profissional.visualizar','Visualizar profissionais de saÃƒÆ’Ã‚Âºde',true),('saude','profissional','criar','saude.profissional.criar','Criar profissionais de saÃƒÆ’Ã‚Âºde',true),('saude','profissional','editar','saude.profissional.editar','Editar profissionais de saÃƒÆ’Ã‚Âºde',true),('saude','profissional','excluir','saude.profissional.excluir','Excluir profissionais de saÃƒÆ’Ã‚Âºde',true),
...
('saude','prontuario','visualizar','saude.prontuario.visualizar','Visualizar prontuÃƒÆ’Ã‚Â¡rio',true),('saude','prontuario','editar','saude.prontuario.editar','Editar prontuÃƒÆ’Ã‚Â¡rio',true),('saude','prontuario','visualizar_dados_sensiveis','saude.prontuario.visualizar_dados_sensiveis','Visualizar dados sensÃƒÆ’Ã‚Â­veis de prontuÃƒÆ’Ã‚Â¡rio',true),
...
('saude','farmacia','visualizar','saude.farmacia.visualizar','Visualizar farmÃƒÆ’Ã‚Â¡cia',true),('saude','farmacia','produto.criar','saude.farmacia.produto.criar','Criar produto de farmÃƒÆ’Ã‚Â¡cia',true),('saude','farmacia','dispensar','saude.farmacia.dispensar','Dispensar medicamento',true),
('saude','vacinacao','visualizar','saude.vacinacao.visualizar','Visualizar vacinaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),('saude','vacinacao','criar','saude.vacinacao.criar','Registrar vacinaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('saude','laboratorio','visualizar','saude.laboratorio.visualizar','Visualizar laboratÃƒÆ’Ã‚Â³rio',true),('saude','laboratorio','criar','saude.laboratorio.criar','Criar exame',true),('saude','laboratorio','resultado','saude.laboratorio.resultado','Registrar resultado de exame',true),
('saude','regulacao','visualizar','saude.regulacao.visualizar','Visualizar regulaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),('saude','regulacao','criar','saude.regulacao.criar','Criar regulaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),('saude','regulacao','editar','saude.regulacao.editar','Editar regulaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
...
('saude','dashboard','visualizar','saude.dashboard.visualizar','Visualizar dashboard saÃƒÆ’Ã‚Âºde',true),('saude','exportar','exportar','saude.exportar','Exportar dados de saÃƒÆ’Ã‚Âºde',true)
on conflict do nothing;
...
begin
    ...
    if v_tenant is not null and v_entidade is not null then
        ...
        values (v_tenant, v_entidade, 'UBS-DEMO', 'Unidade BÃƒÆ’Ã‚Â¡sica de SaÃƒÆ’Ã‚Âºde Demo', null, 'BASICA', 'ATIVA', '{}'::jsonb, '{}'::jsonb)
        on conflict (tenant_id, entidade_id, codigo) do nothing;
        ...
        values (v_tenant, v_entidade, 'MED-DEMO', 'Medicamento Demo', 'PrincÃƒÆ’Ã‚Â­pio ativo demo', 'UN')
        on conflict (tenant_id, entidade_id, codigo) do nothing;
        ...
        if v_unidade is not null and v_produto is not null then
            ...
            values (v_tenant, v_entidade, v_unidade, 'MA-DEMO', 'MicroÃƒÆ’Ã‚Â¡rea Demo')
            on conflict (tenant_id, entidade_id, codigo) do nothing;
        end if;
    end if;
end $$;
-- >>> database/postgres/migrations/023_saneamento_base.sql
-- Saneamento base - schema ÃƒÆ’Ã‚Âºnico sigov, PostgreSQL, Dapper-ready e idempotente.
create extension if not exists pgcrypto;
...
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo)
values ('saneamento','Saneamento','Consumidores, ligaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes, leituras, faturas, laboratÃƒÆ’Ã‚Â³rio e rede estrutural.','Operacional',80,'/Saneamento/Dashboard','droplet',true)
on conflict (codigo) do nothing;
...
('saneamento','ligacao','visualizar','saneamento.ligacao.visualizar','Visualizar ligaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes',true),
('saneamento','ligacao','criar','saneamento.ligacao.criar','Criar ligaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes',true),
('saneamento','ligacao','editar','saneamento.ligacao.editar','Editar ligaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes',true),
('saneamento','ligacao','excluir','saneamento.ligacao.excluir','Excluir ligaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes',true),
...
('saneamento','hidrometro','visualizar','saneamento.hidrometro.visualizar','Visualizar hidrÃƒÆ’Ã‚Â´metros',true),
('saneamento','hidrometro','criar','saneamento.hidrometro.criar','Criar hidrÃƒÆ’Ã‚Â´metros',true),
('saneamento','hidrometro','editar','saneamento.hidrometro.editar','Editar hidrÃƒÆ’Ã‚Â´metros',true),
('saneamento','hidrometro','excluir','saneamento.hidrometro.excluir','Excluir hidrÃƒÆ’Ã‚Â´metros',true),
...
('saneamento','arrecadacao','visualizar','saneamento.arrecadacao.visualizar','Visualizar arrecadaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('saneamento','arrecadacao','criar','saneamento.arrecadacao.criar','Criar arrecadaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
...
('saneamento','laboratorio','visualizar','saneamento.laboratorio.visualizar','Visualizar laboratÃƒÆ’Ã‚Â³rio',true),
...
-- MÃƒÆ’Ã‚Â³dulo AssistÃƒÆ’Ã‚Âªncia Social Base - schema ÃƒÆ’Ã‚Âºnico sigov, idempotente.
create extension if not exists pgcrypto;
...
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo) values ('social','AssistÃƒÆ’Ã‚Âªncia Social','MÃƒÆ’Ã‚Â³dulo base de AssistÃƒÆ’Ã‚Âªncia Social','FinalÃƒÆ’Ã‚Â­stico',60,'/Social/Dashboard','bi-people',true) on conflict (codigo) do nothing;
insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo) values ('assistencia_social','AssistÃƒÆ’Ã‚Âªncia Social','Alias de licenciamento para AssistÃƒÆ’Ã‚Âªncia Social','FinalÃƒÆ’Ã‚Â­stico',61,'/Social/Dashboard','bi-people',true) on conflict (codigo) do nothing;
insert into sigov.permissao (modulo, recurso, acao, chave, descricao, ativo) values
('social','dashboard','visualizar','social.dashboard.visualizar','Visualizar dashboard social',true),('social','unidade','visualizar','social.unidade.visualizar','Visualizar unidades sociais',true),('social','unidade','criar','social.unidade.criar','Criar unidade social',true),('social','unidade','editar','social.unidade.editar','Editar unidade social',true),('social','unidade','excluir','social.unidade.excluir','Excluir unidade social',true),('social','familia','visualizar','social.familia.visualizar','Visualizar famÃƒÆ’Ã‚Â­lias',true),('social','familia','criar','social.familia.criar','Criar famÃƒÆ’Ã‚Â­lia',true),('social','familia','editar','social.familia.editar','Editar famÃƒÆ’Ã‚Â­lia',true),('social','familia','excluir','social.familia.excluir','Excluir famÃƒÆ’Ã‚Â­lia',true),('social','familia','visualizar_dados_completos','social.familia.visualizar_dados_completos','Visualizar dados completos de famÃƒÆ’Ã‚Â­lia',true),('social','pessoa','visualizar','social.pessoa.visualizar','Visualizar pessoas sociais',true),('social','pessoa','criar','social.pessoa.criar','Criar pessoa social',true),('social','pessoa','editar','social.pessoa.editar','Editar pessoa social',true),('social','pessoa','excluir','social.pessoa.excluir','Excluir pessoa social',true),('social','cadastro','criar','social.cadastro.criar','Criar cadastro social',true),('social','vulnerabilidade','criar','social.vulnerabilidade.criar','Registrar vulnerabilidade',true),('social','programa','visualizar','social.programa.visualizar','Visualizar programas',true),('social','programa','criar','social.programa.criar','Criar programa',true),('social','programa','editar','social.programa.editar','Editar programa',true),('social','programa','excluir','social.programa.excluir','Excluir programa',true),('social','beneficio','visualizar','social.beneficio.visualizar','Visualizar benefÃƒÆ’Ã‚Â­cios',true),('social','beneficio','criar','social.beneficio.criar','Criar benefÃƒÆ’Ã‚Â­cio',true),('social','beneficio','editar','social.beneficio.editar','Editar benefÃƒÆ’Ã‚Â­cio',true),('social','beneficio','conceder','social.beneficio.conceder','Conceder benefÃƒÆ’Ã‚Â­cio',true),('social','beneficio','autorizar','social.beneficio.autorizar','Autorizar benefÃƒÆ’Ã‚Â­cio',true),('social','beneficio','entregar','social.beneficio.entregar','Entregar benefÃƒÆ’Ã‚Â­cio',true),('social','atendimento','visualizar','social.atendimento.visualizar','Visualizar atendimentos',true),('social','atendimento','criar','social.atendimento.criar','Criar atendimento',true),('social','atendimento','encaminhar','social.atendimento.encaminhar','Criar encaminhamento',true),('social','visita','visualizar','social.visita.visualizar','Visualizar visitas',true),('social','visita','criar','social.visita.criar','Criar visita',true),('social','parecer','visualizar','social.parecer.visualizar','Visualizar pareceres',true),('social','parecer','criar','social.parecer.criar','Criar parecer',true),('social','parecer','visualizar_sigiloso','social.parecer.visualizar_sigiloso','Visualizar parecer sigiloso',true),('social','acompanhamento','visualizar','social.acompanhamento.visualizar','Visualizar acompanhamento',true),('social','acompanhamento','criar','social.acompanhamento.criar','Criar acompanhamento',true),('social','acompanhamento','encerrar','social.acompanhamento.encerrar','Encerrar acompanhamento',true),('social','vigilancia','visualizar','social.vigilancia.visualizar','Visualizar vigilÃƒÆ’Ã‚Â¢ncia',true),('social','vigilancia','criar','social.vigilancia.criar','Criar vigilÃƒÆ’Ã‚Â¢ncia',true),('social','exportar','executar','social.exportar','Exportar dados sociais',true) on conflict (modulo, recurso, acao) do nothing;
-- >>> database/postgres/migrations/025_integracoes_outbox_webhooks_base.sql
-- SIGOV - IntegraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes oficiais, outbox avanÃƒÆ’Ã‚Â§ado, webhooks, API credentials e estruturas Gov.br/ICP-Brasil.
-- Migration incremental e idempotente; todas as tabelas permanecem no schema ÃƒÆ’Ã‚Âºnico sigov.
...
insert into sigov.modulo_saas (codigo,nome,descricao,categoria,ordem,rota_base,icone,ativo)
values ('integracao','IntegraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes','IntegraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes oficiais, API credentials, webhooks, outbox, Gov.br e ICP-Brasil estrutural.','Plataforma',90,'/Integracoes','bi-diagram-3',true)
...
('integracao','integracao.sistema.visualizar','integracao.sistema','visualizar','Visualizar sistemas de integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('integracao','integracao.sistema.criar','integracao.sistema','criar','Criar sistemas de integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('integracao','integracao.sistema.editar','integracao.sistema','editar','Editar sistemas de integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('integracao','integracao.sistema.excluir','integracao.sistema','excluir','Excluir sistemas de integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
...
('integracao','integracao.dashboard.visualizar','integracao.dashboard','visualizar','Visualizar dashboard de integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes',true),
('integracao','integracao.exportar','integracao.exportacao','exportar','Exportar dados de integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes',true)
...
-- Agro e Desenvolvimento Rural - fundaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, georreferenciamento estrutural e dashboard inicial.
-- Schema ÃƒÆ’Ã‚Âºnico sigov; sem PostGIS obrigatÃƒÆ’Ã‚Â³rio; Dapper/PostgreSQL-ready.

insert into sigov.modulo_saas (codigo, nome, descricao, categoria, ordem, rota_base, icone, ativo)
values ('agro', 'Agro e Desenvolvimento Rural', 'FundaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o do mÃƒÆ’Ã‚Â³dulo Agro com georreferenciamento estrutural e dashboard inicial.', 'PolÃƒÆ’Ã‚Â­ticas pÃƒÆ’Ã‚Âºblicas', 160, '/Agro/Dashboard', 'bi-tree', true)
...
('agro','geo','visualizar','agro.geo.visualizar','Visualizar camadas e feiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes geogrÃƒÆ’Ã‚Â¡ficas do Agro.',true),
('agro','geo','criar','agro.geo.criar','Criar camadas e feiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes geogrÃƒÆ’Ã‚Â¡ficas do Agro.',true),
('agro','geo','editar','agro.geo.editar','Editar camadas e feiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes geogrÃƒÆ’Ã‚Â¡ficas do Agro.',true),
('agro','geo','excluir','agro.geo.excluir','Excluir camadas e feiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes geogrÃƒÆ’Ã‚Â¡ficas do Agro.',true),
('agro','geo','exportar','agro.geo.exportar','Exportar dados geogrÃƒÆ’Ã‚Â¡ficos do Agro em GeoJSON.',true)
on conflict (modulo, recurso, acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo)
values
('agro.dashboard','Dashboard Agro','Habilita o dashboard inicial do mÃƒÆ’Ã‚Â³dulo Agro.','agro',true),
('agro.geo','Georreferenciamento Agro','Habilita camadas e feiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes geogrÃƒÆ’Ã‚Â¡ficas estruturais do Agro.','agro',true),
('agro.exportacao_geojson','ExportaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o GeoJSON Agro','Habilita exportaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o estrutural GeoJSON do Agro.','agro',true)
...
-- FundaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o SaaS parametrizÃƒÆ’Ã‚Â¡vel do sigov: schema ÃƒÆ’Ã‚Âºnico sigov, Dapper/PostgreSQL e isolamento por tenant.
...
('ADMINISTRADOR_GERAL', 'Administrador Geral', 'Administra todo o sigov e todos os tenants com auditoria obrigatÃƒÆ’Ã‚Â³ria.', 1000, true, false),
('ADMINISTRADOR_TENANT', 'Administrador do Tenant', 'Administra apenas o prÃƒÆ’Ã‚Â³prio tenant.', 900, false, true),
('ADMINISTRADOR_ENTIDADE', 'Administrador de Entidade', 'Administra uma entidade especÃƒÆ’Ã‚Â­fica dentro do tenant.', 800, false, false),
('COORDENADOR', 'Coordenador', 'Coordena mÃƒÆ’Ã‚Â³dulos, setores, equipes ou unidades conforme permissÃƒÆ’Ã‚Âµes.', 700, false, false),
('DIRETOR', 'Diretor', 'Gerencia unidade, escola, secretaria, departamento ou ÃƒÆ’Ã‚Â¡rea conforme escopo.', 600, false, false),
('SERVIDOR', 'Servidor', 'Executa tarefas operacionais prÃƒÆ’Ã‚Â³prias ou atribuÃƒÆ’Ã‚Â­das.', 500, false, false),
('OPERADOR', 'Operador', 'Executa permissÃƒÆ’Ã‚Âµes operacionais explÃƒÆ’Ã‚Â­citas.', 400, false, false),
('CONSULTA', 'Consulta', 'UsuÃƒÆ’Ã‚Â¡rio somente leitura conforme escopo.', 300, false, false),
('AUDITOR', 'Auditor', 'Acessa auditoria e conformidade conforme permissÃƒÆ’Ã‚Â£o.', 200, false, false),
('SUPORTE', 'Suporte', 'Suporte tÃƒÆ’Ã‚Â©cnico controlado e auditado.', 100, false, false)
...
('ESSENCIAL','Essencial','FundaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o mÃƒÆ’Ã‚Â­nima da plataforma.','["core","seguranca","auditoria","lgpd","suporte"]'::jsonb),
('FINANCEIRO_TRIBUTARIO','Financeiro e TributÃƒÆ’Ã‚Â¡rio','GestÃƒÆ’Ã‚Â£o fiscal, arrecadaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o e relatÃƒÆ’Ã‚Â³rios.','["financeiro","tributario","relatorios"]'::jsonb),
('GESTAO_ADMINISTRATIVA','GestÃƒÆ’Ã‚Â£o Administrativa','Backoffice administrativo municipal.','["processos","compras","contratos","almoxarifado","patrimonio","frotas","obras"]'::jsonb),
('SOCIAL_SAUDE_EDUCACAO','Social, SaÃƒÆ’Ã‚Âºde e EducaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','PolÃƒÆ’Ã‚Â­ticas pÃƒÆ’Ã‚Âºblicas integradas.','["educacao","saude","social"]'::jsonb),
('AGRO_RURAL','Agro Rural','Base futura rural integrada.','["agro","frotas","obras","tributario","relatorios"]'::jsonb),
('COMPLETO','Completo','Todos os mÃƒÆ’Ã‚Â³dulos integrados do sigov.','["core","seguranca","auditoria","lgpd","processos","financeiro","tributario","compras","contratos","almoxarifado","patrimonio","frotas","obras","rh","educacao","saude","saneamento","social","relatorios","transparencia","integracoes","suporte","operacao","agro"]'::jsonb)
...
('agro','talhao','visualizar','agro.talhao.visualizar','Visualizar talhÃƒÆ’Ã‚Âµes.',true),('agro','talhao','criar','agro.talhao.criar','Criar talhÃƒÆ’Ã‚Âµes.',true),('agro','talhao','editar','agro.talhao.editar','Editar talhÃƒÆ’Ã‚Âµes.',true),
...
('agro','producao','visualizar','agro.producao.visualizar','Visualizar produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o agrÃƒÆ’Ã‚Â­cola.',true),('agro','producao','criar','agro.producao.criar','Criar produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o agrÃƒÆ’Ã‚Â­cola.',true),('agro','producao','editar','agro.producao.editar','Editar produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o agrÃƒÆ’Ã‚Â­cola.',true),('agro','producao','excluir','agro.producao.excluir','Excluir produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o agrÃƒÆ’Ã‚Â­cola.',true)
on conflict (chave) do update set descricao=excluded.descricao, ativo=true, is_deleted=false;

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo)
values ('agro.produtores','Produtores rurais','Habilita cadastro de produtores rurais.','agro',true),('agro.producao','ProduÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o agrÃƒÆ’Ã‚Â­cola','Habilita cadastros produtivos agrÃƒÆ’Ã‚Â­colas.','agro',true)
...
select t.id, e.id, x.codigo, x.nome, x.tipo, x.unidade, null from sigov.tenant t join sigov.entidade e on e.tenant_id=t.id cross join (values ('MILHO','Milho','GRAOS','kg'),('FEIJAO','FeijÃƒÆ’Ã‚Â£o','GRAOS','kg'),('MANDIOCA','Mandioca','RAIZES_TUBERCULOS','kg'),('ARROZ','Arroz','GRAOS','kg'),('HORTALICAS','HortaliÃƒÆ’Ã‚Â§as','HORTALICAS','kg'),('FRUTAS','Frutas','FRUTAS','kg'),('PASTAGEM','Pastagem','PASTAGEM','ha')) as x(codigo,nome,tipo,unidade) where t.ambiente='Development' and not exists (select 1 from sigov.agro_cultura c where c.tenant_id=t.id and c.entidade_id=e.id and c.codigo=x.codigo and c.is_deleted=false);
...
-- Agro Parte 4: programas, benefÃƒÆ’Ã‚Â­cios, insumos e patrulha mecanizada.
-- Schema ÃƒÆ’Ã‚Âºnico sigov; migration idempotente; sem schemas agro/rural/geo.

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo)
values
('agro.programas_rurais','Programas rurais','Habilita programas rurais do Agro.','agro',true),
('agro.beneficios_rurais','BenefÃƒÆ’Ã‚Â­cios rurais','Habilita benefÃƒÆ’Ã‚Â­cios e concessÃƒÆ’Ã‚Âµes rurais.','agro',true),
('agro.insumos','Insumos Agro','Habilita insumos e distribuiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes rurais.','agro',true),
('agro.patrulha_mecanizada','Patrulha mecanizada','Habilita patrulha mecanizada rural.','agro',true),
('agro.maquinas','MÃƒÆ’Ã‚Â¡quinas rurais','Habilita mÃƒÆ’Ã‚Â¡quinas e implementos rurais.','agro',true),
('agro.servicos_maquina','ServiÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quinas','Habilita serviÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quinas rurais.','agro',true)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, modulo=excluded.modulo, ativo=true;
...
('agro','beneficio','visualizar','agro.beneficio.visualizar','Visualizar benefÃƒÆ’Ã‚Â­cios rurais.',true),('agro','beneficio','criar','agro.beneficio.criar','Criar benefÃƒÆ’Ã‚Â­cios rurais.',true),('agro','beneficio','editar','agro.beneficio.editar','Editar benefÃƒÆ’Ã‚Â­cios rurais.',true),('agro','beneficio','excluir','agro.beneficio.excluir','Excluir benefÃƒÆ’Ã‚Â­cios rurais.',true),('agro','beneficio','conceder','agro.beneficio.conceder','Solicitar concessÃƒÆ’Ã‚Âµes de benefÃƒÆ’Ã‚Â­cio rural.',true),('agro','beneficio','autorizar','agro.beneficio.autorizar','Autorizar concessÃƒÆ’Ã‚Âµes de benefÃƒÆ’Ã‚Â­cio rural.',true),('agro','beneficio','entregar','agro.beneficio.entregar','Entregar concessÃƒÆ’Ã‚Âµes de benefÃƒÆ’Ã‚Â­cio rural.',true),('agro','beneficio','indeferir','agro.beneficio.indeferir','Indeferir concessÃƒÆ’Ã‚Âµes de benefÃƒÆ’Ã‚Â­cio rural.',true),('agro','beneficio','cancelar','agro.beneficio.cancelar','Cancelar concessÃƒÆ’Ã‚Âµes de benefÃƒÆ’Ã‚Â­cio rural.',true),
...
('agro','maquina','visualizar','agro.maquina.visualizar','Visualizar mÃƒÆ’Ã‚Â¡quinas rurais.',true),('agro','maquina','criar','agro.maquina.criar','Criar mÃƒÆ’Ã‚Â¡quinas rurais.',true),('agro','maquina','editar','agro.maquina.editar','Editar mÃƒÆ’Ã‚Â¡quinas rurais.',true),('agro','maquina','excluir','agro.maquina.excluir','Excluir mÃƒÆ’Ã‚Â¡quinas rurais.',true),
...
('agro','servico_maquina','visualizar','agro.servico_maquina.visualizar','Visualizar serviÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quinas.',true),('agro','servico_maquina','criar','agro.servico_maquina.criar','Criar serviÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quinas.',true),('agro','servico_maquina','editar','agro.servico_maquina.editar','Editar serviÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quinas.',true),('agro','servico_maquina','agendar','agro.servico_maquina.agendar','Agendar serviÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quinas.',true),('agro','servico_maquina','executar','agro.servico_maquina.executar','Executar serviÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quinas.',true),('agro','servico_maquina','cancelar','agro.servico_maquina.cancelar','Cancelar serviÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quinas.',true),('agro','servico_maquina','excluir','agro.servico_maquina.excluir','Excluir serviÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quinas.',true)
on conflict (modulo, recurso, acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;
...
select t.id, e.id, x.codigo, x.nome, x.tipo, 'Seed Development Agro Parte 4', null from sigov.tenant t join sigov.entidade e on e.tenant_id=t.id cross join (values ('CORTE_TERRA','Corte de Terra','CORTE_TERRA'),('DIST_SEMENTES','DistribuiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o de Sementes','DISTRIBUICAO_SEMENTES'),('DIST_MUDAS','DistribuiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o de Mudas','DISTRIBUICAO_MUDAS'),('PATRULHA_MEC','Patrulha Mecanizada','PATRULHA_MECANIZADA')) as x(codigo,nome,tipo)
...
select t.id, e.id, x.codigo, x.nome, x.tipo, x.unidade, false, null from sigov.tenant t join sigov.entidade e on e.tenant_id=t.id cross join (values ('SEMENTE','Semente','SEMENTE','kg'),('MUDA','Muda','MUDA','un'),('CALCARIO','CalcÃƒÆ’Ã‚Â¡rio','CALCARIO','kg'),('ADUBO','Adubo','ADUBO','kg')) as x(codigo,nome,tipo,unidade)
...
create table if not exists sigov.b2b_tenant_white_label (
    ...
    nome_plataforma varchar(160) not null default 'PlantÃƒÆ’Ã‚Â£oPro',
    nome_comercial varchar(160) not null default 'PlantÃƒÆ’Ã‚Â£oPro',
...
values
('ESSENCIAL', 'Plano Essencial', 'OperaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o inicial para escalas e plantÃƒÆ’Ã‚Âµes mÃƒÆ’Ã‚Â©dicos.', 'Hospitais e clÃƒÆ’Ã‚Â­nicas em inÃƒÆ’Ã‚Â­cio de operaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o digital', 499, false, false, 5, 20, 2, 100, 'Suporte padrÃƒÆ’Ã‚Â£o', 10),
('PROFISSIONAL', 'Plano Profissional', 'OperaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o assistida com API limitada, relatÃƒÆ’Ã‚Â³rios avanÃƒÆ’Ã‚Â§ados e white label bÃƒÆ’Ã‚Â¡sico.', 'OperaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes multiunidade em crescimento', 1499, true, true, 20, 100, 10, 500, 'Suporte prioritÃƒÆ’Ã‚Â¡rio', 20),
('ENTERPRISE_WHITE_LABEL', 'Enterprise White Label', 'White label completo, domÃƒÆ’Ã‚Â­nio customizado, API, webhooks, BI e SLA.', 'Redes de saÃƒÆ’Ã‚Âºde e operaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes B2B', 4990, true, true, 999999, 999999, 999999, 999999, 'SLA contratual', 30),
('REVENDEDOR', 'Plano Revendedor', 'Console parceiro, tenants vinculados, margem, comissÃƒÆ’Ã‚Â£o e repasses.', 'Parceiros e consultorias', 7990, true, true, 999999, 999999, 999999, 999999, 'SLA B2B para parceiros', 40),
('CUSTOM', 'Plano Custom', 'Contrato personalizado, integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes especÃƒÆ’Ã‚Â­ficas e infraestrutura dedicada opcional.', 'Projetos sob proposta', 0, true, true, 999999, 999999, 999999, 999999, 'SLA customizado', 50)
...
values
('One page comercial PlantÃƒÆ’Ã‚Â£oPro', 'ONE_PAGE', 'parceiro', 'Resumo comercial para hospitais, redes de saÃƒÆ’Ã‚Âºde e parceiros.'),
('Roteiro de demonstraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o white label', 'DEMO', 'interno', 'Fluxo de planos, self-service, white label, API, suporte e monitoramento.'),
('ArgumentÃƒÆ’Ã‚Â¡rio para CTO', 'ARGUMENTARIO', 'parceiro', 'SeguranÃƒÆ’Ã‚Â§a, isolamento por tenant, API keys, LGPD, auditoria e observabilidade.'),
('Proposta comercial modelo', 'PROPOSTA', 'interno', 'Modelo de proposta B2B com setup, SLA, revenda e customizaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes.')
on conflict do nothing;
...
values
('ESSENCIAL','Essencial','Core, SeguranÃƒÆ’Ã‚Â§a, Auditoria/LGPD e suporte bÃƒÆ’Ã‚Â¡sico.',true,false,10,'PUBLICO',null,'MENSAL',20,2,10240,false,false),
('FINANCEIRO_TRIBUTARIO','Financeiro e TributÃƒÆ’Ã‚Â¡rio','Pacote para financeiro, tributÃƒÆ’Ã‚Â¡rio e relatÃƒÆ’Ã‚Â³rios.',true,false,20,'PUBLICO',null,'MENSAL',50,5,20480,false,false),
('GESTAO_ADMINISTRATIVA','GestÃƒÆ’Ã‚Â£o Administrativa','Processos, compras, contratos, almoxarifado, patrimÃƒÆ’Ã‚Â´nio, frotas e obras.',true,false,30,'PUBLICO',null,'MENSAL',100,10,51200,false,false),
('SOCIAL_SAUDE_EDUCACAO','Social, SaÃƒÆ’Ã‚Âºde e EducaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','EducaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, saÃƒÆ’Ã‚Âºde e assistÃƒÆ’Ã‚Âªncia social integradas.',true,false,40,'PUBLICO',null,'MENSAL',150,20,102400,false,false),
('AGRO_RURAL','Agro Rural','Agro, frotas, obras e relatÃƒÆ’Ã‚Â³rios com tributÃƒÆ’Ã‚Â¡rio opcional.',true,false,50,'PUBLICO',null,'MENSAL',60,10,51200,false,false),
('COMPLETO','Completo','Todos os mÃƒÆ’Ã‚Â³dulos do sigov com white label e domÃƒÆ’Ã‚Â­nio customizado.',true,true,60,'PUBLICO',null,'MENSAL',300,50,204800,true,true),
('ENTERPRISE','Enterprise','Plano personalizado para operaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o municipal avanÃƒÆ’Ã‚Â§ada.',true,false,70,'ENTERPRISE',null,'PERSONALIZADA',null,null,null,true,true)
...
values
('USUARIOS_EXTRAS','UsuÃƒÆ’Ã‚Â¡rios extras','Pacote adicional de usuÃƒÆ’Ã‚Â¡rios.','USUARIOS_EXTRAS',null,null,'MENSAL'),
('ARMAZENAMENTO_EXTRA','Armazenamento extra','Armazenamento adicional.','ARMAZENAMENTO_EXTRA',null,null,'MENSAL'),
('WHITE_LABEL','White label','Identidade visual prÃƒÆ’Ã‚Â³pria do tenant.','WHITE_LABEL',null,null,'MENSAL'),
('DOMINIO_CUSTOMIZADO','DomÃƒÆ’Ã‚Â­nio customizado','DomÃƒÆ’Ã‚Â­nio estrutural customizado.','DOMINIO_CUSTOMIZADO',null,null,'MENSAL'),
('SUPORTE_PREMIUM','Suporte premium','Suporte tÃƒÆ’Ã‚Â©cnico ampliado.','SUPORTE_PREMIUM',null,null,'MENSAL'),
('TRIBUTARIO_EXTRA','TributÃƒÆ’Ã‚Â¡rio opcional','MÃƒÆ’Ã‚Â³dulo TributÃƒÆ’Ã‚Â¡rio adicional.','MODULO_EXTRA','tributario',null,'MENSAL')
...
from sigov.saas_plano p
join (values
('usuarios','UsuÃƒÆ’Ã‚Â¡rios',null,'usuarios',false),('entidades','Entidades',null,'entidades',false),('armazenamento_mb','Armazenamento',null,'MB',false),('api_requests_mes','RequisiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes API/mÃƒÆ’Ã‚Âªs',50000,'requests',false),('relatorios_agendados','RelatÃƒÆ’Ã‚Â³rios agendados',10,'relatÃƒÆ’Ã‚Â³rios',false),('integracoes','IntegraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes',3,'integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes',false),('white_label','White label',null,null,false),('dominio_customizado','DomÃƒÆ’Ã‚Â­nio customizado',null,null,false)
...
('COORDENADOR','Coordenador','COORDENADOR','Coordena mÃƒÆ’Ã‚Â³dulos, setores ou unidades permitidas.', '[]'::jsonb),
...
('AUDITOR','Auditor','AUDITOR','Acessa auditoria e conformidade conforme permissÃƒÆ’Ã‚Â£o.', '["saas.assinaturas.visualizar"]'::jsonb)
...
-- Agro Parte 5 - Estradas vicinais, pontos crÃƒÆ’Ã‚Â­ticos, feiras, agroindÃƒÆ’Ã‚Âºstrias e compras AF.
-- Idempotente; schema ÃƒÆ’Ã‚Âºnico sigov; sem PostGIS obrigatÃƒÆ’Ã‚Â³rio; sem integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes financeiras/tributÃƒÆ’Ã‚Â¡rias reais.

insert into sigov.feature_flag_def (codigo, nome, descricao, modulo, ativo) values
('agro.estradas_vicinais','Estradas Vicinais','Habilita cadastro e gestÃƒÆ’Ã‚Â£o de estradas vicinais.','agro',true),
('agro.pontos_criticos','Pontos CrÃƒÆ’Ã‚Â­ticos Rurais','Habilita pontes, bueiros, passagens molhadas e pontos crÃƒÆ’Ã‚Â­ticos.','agro',true),
('agro.ocorrencias_rurais','OcorrÃƒÆ’Ã‚Âªncias Rurais','Habilita ocorrÃƒÆ’Ã‚Âªncias rurais estruturais.','agro',true),
('agro.feiras','Feiras e Mercados Rurais','Habilita feiras, feirantes, bancas e autorizaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes.','agro',true),
('agro.agroindustrias','AgroindÃƒÆ’Ã‚Âºstrias','Habilita agroindÃƒÆ’Ã‚Âºstrias municipais estruturais.','agro',true),
('agro.inspecao_municipal','InspeÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o Municipal','Habilita inspeÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o municipal estrutural.','agro',true),
...
('agro','ponto_critico','visualizar','agro.ponto_critico.visualizar','Visualizar pontos crÃƒÆ’Ã‚Â­ticos.',true),('agro','ponto_critico','criar','agro.ponto_critico.criar','Criar pontos crÃƒÆ’Ã‚Â­ticos.',true),('agro','ponto_critico','editar','agro.ponto_critico.editar','Editar pontos crÃƒÆ’Ã‚Â­ticos.',true),('agro','ponto_critico','resolver','agro.ponto_critico.resolver','Resolver pontos crÃƒÆ’Ã‚Â­ticos.',true),
('agro','ocorrencia','visualizar','agro.ocorrencia.visualizar','Visualizar ocorrÃƒÆ’Ã‚Âªncias rurais.',true),('agro','ocorrencia','criar','agro.ocorrencia.criar','Criar ocorrÃƒÆ’Ã‚Âªncias rurais.',true),('agro','ocorrencia','editar','agro.ocorrencia.editar','Editar ocorrÃƒÆ’Ã‚Âªncias rurais.',true),('agro','ocorrencia','resolver','agro.ocorrencia.resolver','Resolver ocorrÃƒÆ’Ã‚Âªncias rurais.',true),('agro','ocorrencia','cancelar','agro.ocorrencia.cancelar','Cancelar ocorrÃƒÆ’Ã‚Âªncias rurais.',true),
('agro','manutencao','visualizar','agro.manutencao.visualizar','Visualizar manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes rurais.',true),('agro','manutencao','criar','agro.manutencao.criar','Criar manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes rurais.',true),('agro','manutencao','executar','agro.manutencao.executar','Executar manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes rurais.',true),('agro','manutencao','cancelar','agro.manutencao.cancelar','Cancelar manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes rurais.',true),
...
('agro','agroindustria','visualizar','agro.agroindustria.visualizar','Visualizar agroindÃƒÆ’Ã‚Âºstrias.',true),('agro','agroindustria','criar','agro.agroindustria.criar','Criar agroindÃƒÆ’Ã‚Âºstrias.',true),('agro','agroindustria','editar','agro.agroindustria.editar','Editar agroindÃƒÆ’Ã‚Âºstrias.',true),('agro','agroindustria','excluir','agro.agroindustria.excluir','Excluir agroindÃƒÆ’Ã‚Âºstrias.',true),
('agro','inspecao','visualizar','agro.inspecao.visualizar','Visualizar inspeÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes municipais.',true),('agro','inspecao','criar','agro.inspecao.criar','Criar inspeÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes municipais.',true),('agro','inspecao','concluir','agro.inspecao.concluir','Concluir inspeÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes municipais.',true),
...
select t.id, e.id, c.codigo, c.nome, c.tipo, c.nome, false from sigov.tenant t join sigov.entidade e on e.tenant_id=t.id cross join (values ('ESTRADAS_VICINAIS','Estradas Vicinais','ESTRADAS'),('PONTOS_CRITICOS','Pontos CrÃƒÆ’Ã‚Â­ticos','PONTOS_CRITICOS'),('OCORRENCIAS_RURAIS','OcorrÃƒÆ’Ã‚Âªncias Rurais','OCORRENCIAS'),('FEIRAS_RURAIS','Feiras','FEIRAS'),('AGROINDUSTRIAS','AgroindÃƒÆ’Ã‚Âºstrias','AGROINDUSTRIAS')) c(codigo,nome,tipo) where t.ativo=true and t.is_deleted=false on conflict do nothing;
...
-- Eventos estruturais previstos para sigov.agro_evento/sigov.fila_evento, sem integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o real nesta etapa:
...
-- AgroGeoFeicaoAtualizada. Payload mÃƒÆ’Ã‚Â­nimo: tenantId, entidadeId, exercicioId, origem, origemId, tipoEvento, correlationId.
...
from sigov.tenant t
cross join (values
('total_produtores','Total de produtores','PRODUTORES',null),('total_propriedades','Total de propriedades','PROPRIEDADES',null),('area_produtiva_ha','ÃƒÆ’Ã‚Ârea produtiva','PROPRIEDADES','ha'),('total_culturas','Total de culturas','PRODUCAO',null),('producao_estimada','ProduÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o estimada','PRODUCAO',null),('producao_realizada','ProduÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o realizada','PRODUCAO',null),('total_rebanhos','Total de rebanhos','PECUARIA',null),('total_animais','Total de animais','PECUARIA',null),('visitas_tecnicas_mes','Visitas tÃƒÆ’Ã‚Â©cnicas no mÃƒÆ’Ã‚Âªs','ASSISTENCIA_TECNICA',null),('beneficios_entregues_mes','BenefÃƒÆ’Ã‚Â­cios entregues no mÃƒÆ’Ã‚Âªs','PROGRAMAS',null),('servicos_maquina_executados_mes','ServiÃƒÆ’Ã‚Â§os de mÃƒÆ’Ã‚Â¡quina executados no mÃƒÆ’Ã‚Âªs','PATRULHA_MECANIZADA',null),('estradas_vicinais_km','Estradas vicinais em km','ESTRADAS','km'),('pontos_criticos_abertos','Pontos crÃƒÆ’Ã‚Â­ticos abertos','ESTRADAS',null),('feiras_ativas','Feiras ativas','FEIRAS',null),('agroindustrias_ativas','AgroindÃƒÆ’Ã‚Âºstrias ativas','AGROINDUSTRIA',null),('compras_af_mes','Compras da agricultura familiar no mÃƒÆ’Ã‚Âªs','COMPRAS_AF',null)
...
('agro_produtor','pessoa_id','Pessoa do produtor','ReferÃƒÆ’Ã‚Âªncia interna ao cadastro de pessoa; nunca expor em dados abertos.','PRODUTORES',true,false,false,'ID_INTERNO'),
('agro_propriedade','endereco_json','EndereÃƒÆ’Ã‚Â§o da propriedade','EndereÃƒÆ’Ã‚Â§o completo deve ser mascarado em exportaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes pÃƒÆ’Ã‚Âºblicas.','PROPRIEDADES',true,false,false,'ENDERECO_MASCARADO'),
('agro_agroindustria','endereco_json','EndereÃƒÆ’Ã‚Â§o da agroindÃƒÆ’Ã‚Âºstria','EndereÃƒÆ’Ã‚Â§o completo deve ser mascarado em exportaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes pÃƒÆ’Ã‚Âºblicas.','AGROINDUSTRIA',true,false,false,'ENDERECO_MASCARADO'),
('agro_compra_agricultura_familiar','produto','Produto adquirido','Campo publicÃƒÆ’Ã‚Â¡vel apenas agregado por produto.','COMPRAS_AF',false,false,true,null)
on conflict do nothing;
...
values ('Administrador Geral', 'Perfil global para administraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o SaaS inicial do SIGOV.', 'ADMINISTRADOR_GERAL', true)
on conflict do nothing;
...
values
    ...
    ('saas', 'modulos', 'visualizar', 'saas.modulos.visualizar', 'Visualizar mÃƒÆ’Ã‚Â³dulos SaaS', true),
    ('saas', 'modulos', 'gerenciar', 'saas.modulos.gerenciar', 'Gerenciar mÃƒÆ’Ã‚Â³dulos contratados', true),
    ('operacao', 'health', 'visualizar', 'operacao.health.visualizar', 'Visualizar saÃƒÆ’Ã‚Âºde do ambiente', true)
on conflict do nothing;

insert into sigov.usuario (tenant_id, login, email, senha_hash, nome, ativo, bloqueado, deve_alterar_senha, observacao)
select t.id, 'admin', 'admin@sigov.local', 'SIGOV_PBKDF2_V1$100000$UG9zdEJ1aWxkMDFTYWx0IQ==$C87vVWxqrRbbxe7IoBsv0wuI7NDFYnsFlrAxvqlherg=', 'Administrador Geral', true, false, true, 'UsuÃƒÆ’Ã‚Â¡rio administrador inicial de desenvolvimento com senha documentada em docs/ambiente-local.md'
from sigov.tenant t
...
-- EvoluÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o PÃƒÆ’Ã‚Â³s-Build 03 - Planos SaaS, implantaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o guiada e base tributÃƒÆ’Ã‚Â¡ria parametrizÃƒÆ’Ã‚Â¡vel.
-- Migration idempotente: somente CREATE/ALTER IF NOT EXISTS, ÃƒÆ’Ã‚Â­ndices IF NOT EXISTS e seeds ON CONFLICT.
...
values
('STARTER','Starter','Plano inicial para pequenos ÃƒÆ’Ã‚Â³rgÃƒÆ’Ã‚Â£os e implantaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o piloto.','MENSAL',0,'BRL','MENSAL',10,1,1024,false,false,true,false,true,10),
('GOV_BASIC','Governo BÃƒÆ’Ã‚Â¡sico','Plano para secretarias e ÃƒÆ’Ã‚Â³rgÃƒÆ’Ã‚Â£os com gestÃƒÆ’Ã‚Â£o administrativa.','MENSAL',0,'BRL','MENSAL',50,1,10240,true,false,true,true,true,20),
('GOV_PLUS','Governo Plus','Plano completo para prefeituras e estruturas multiÃƒÆ’Ã‚Â¡reas.','MENSAL',0,'BRL','MENSAL',200,3,51200,true,false,true,true,true,30),
('ENTERPRISE','Enterprise','Plano corporativo com mÃƒÆ’Ã‚Â³dulos ilimitados e domÃƒÆ’Ã‚Â­nio personalizado.','MENSAL',0,'BRL','MENSAL',null,null,null,true,true,false,false,true,40)
...
insert into sigov.saas_plano_limite (plano_id,codigo,nome,valor,unidade,ilimitado)
select p.id, 'usuarios', 'UsuÃƒÆ’Ã‚Â¡rios ativos', p.limite_usuarios, 'usuarios', p.limite_usuarios is null from sigov.saas_plano p
...
('saas','planos','modulos','saas.planos.modulos','Configurar mÃƒÆ’Ã‚Â³dulos de planos SaaS',true),
('saas','planos','limites','saas.planos.limites','Configurar limites de planos SaaS',true),
('tributario','dashboard','visualizar','tributario.dashboard.visualizar','Visualizar dashboard tributÃƒÆ’Ã‚Â¡rio',true),
('tributario','configuracao','visualizar','tributario.configuracao.visualizar','Visualizar configuraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o tributÃƒÆ’Ã‚Â¡ria',true),
('tributario','configuracao','editar','tributario.configuracao.editar','Editar configuraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o tributÃƒÆ’Ã‚Â¡ria',true),
('tributario','tipos','visualizar','tributario.tipos.visualizar','Visualizar tipos tributÃƒÆ’Ã‚Â¡rios',true),
('tributario','tipos','editar','tributario.tipos.editar','Editar tipos tributÃƒÆ’Ã‚Â¡rios',true),
('tributario','campos','visualizar','tributario.campos.visualizar','Visualizar campos dinÃƒÆ’Ã‚Â¢micos tributÃƒÆ’Ã‚Â¡rios',true),
('tributario','campos','editar','tributario.campos.editar','Editar campos dinÃƒÆ’Ã‚Â¢micos tributÃƒÆ’Ã‚Â¡rios',true),
...
('tributario','imoveis','visualizar','tributario.imoveis.visualizar','Visualizar imÃƒÆ’Ã‚Â³veis',true),
('tributario','imoveis','criar','tributario.imoveis.criar','Criar imÃƒÆ’Ã‚Â³veis',true),
('tributario','imoveis','editar','tributario.imoveis.editar','Editar imÃƒÆ’Ã‚Â³veis',true),
('tributario','economicos','visualizar','tributario.economicos.visualizar','Visualizar econÃƒÆ’Ã‚Â´micos',true),
('tributario','economicos','criar','tributario.economicos.criar','Criar econÃƒÆ’Ã‚Â´micos',true),
('tributario','economicos','editar','tributario.economicos.editar','Editar econÃƒÆ’Ã‚Â´micos',true)
on conflict (modulo,recurso,acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;
...
from sigov.tenant t
cross join (values
('orgao.nome',null,'string','Nome do ÃƒÆ’Ã‚Â³rgÃƒÆ’Ã‚Â£o',false),
('orgao.documento',null,'string','Documento do ÃƒÆ’Ã‚Â³rgÃƒÆ’Ã‚Â£o',false),
('orgao.email',null,'string','E-mail institucional',false),
('orgao.telefone',null,'string','Telefone institucional',false),
('orgao.endereco',null,'string','EndereÃƒÆ’Ã‚Â§o institucional',false),
('sistema.timezone','America/Sao_Paulo','string','Timezone padrÃƒÆ’Ã‚Â£o',false),
('sistema.locale','pt-BR','string','Locale padrÃƒÆ’Ã‚Â£o',false),
('sistema.moeda','BRL','string','Moeda padrÃƒÆ’Ã‚Â£o',false),
('lgpd.mascara_dados','true','boolean','Aplicar mÃƒÆ’Ã‚Â¡scara LGPD',false),
('auditoria.retencao_dias','365','number','RetenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o da auditoria',false)
...
from sigov.tenant t
cross join (values
('CONTRIBUINTE','Contribuinte','Cadastro parametrizÃƒÆ’Ã‚Â¡vel de contribuintes'),
('IMOVEL','ImÃƒÆ’Ã‚Â³vel','Cadastro imobiliÃƒÆ’Ã‚Â¡rio parametrizÃƒÆ’Ã‚Â¡vel'),
('ECONOMICO','EconÃƒÆ’Ã‚Â´mico','Cadastro econÃƒÆ’Ã‚Â´mico/mobiliÃƒÆ’Ã‚Â¡rio parametrizÃƒÆ’Ã‚Â¡vel')
) as v(codigo,nome,descricao)
on conflict (tenant_id,codigo) do nothing;
-- >>> database/postgres/migrations/20260610100000_pos_build_04_enterprise_modules.sql
-- SIGOV PÃƒÆ’Ã‚Â³s-Build 04: base comercial, ordem de serviÃƒÆ’Ã‚Â§o, manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o industrial, estoque/compras e comÃƒÆ’Ã‚Â©rcio.
create schema if not exists sigov;
...
insert into sigov.permissao (modulo,recurso,acao,chave,descricao,ativo)
values
('comercial','*','gerenciar','comercial.*','Gerenciar mÃƒÆ’Ã‚Â³dulo Comercial/CRM',true),
('os','*','gerenciar','os.*','Gerenciar mÃƒÆ’Ã‚Â³dulo de Ordem de ServiÃƒÆ’Ã‚Â§o',true),
('industrial','*','gerenciar','industrial.*','Gerenciar mÃƒÆ’Ã‚Â³dulo de ManutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o Industrial',true),
('estoque','*','gerenciar','estoque.*','Gerenciar mÃƒÆ’Ã‚Â³dulo de Estoque',true),
('compras','*','gerenciar','compras.*','Gerenciar mÃƒÆ’Ã‚Â³dulo de Compras',true),
('comercio','*','gerenciar','comercio.*','Gerenciar mÃƒÆ’Ã‚Â³dulo de ComÃƒÆ’Ã‚Â©rcio',true)
on conflict (modulo,recurso,acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;
-- >>> database/postgres/migrations/20260610120000_pos_build_05_comercio_varejo_atacado_pdv_caixa_financeiro.sql
-- SIGOV PÃƒÆ’Ã‚Â³s-Build 05: ComÃƒÆ’Ã‚Â©rcio varejista/atacadista avanÃƒÆ’Ã‚Â§ado, PDV, caixa, estoque integrado e financeiro inicial.
-- Migration idempotente: CREATE TABLE/INDEX IF NOT EXISTS e seeds com ON CONFLICT, sem remoÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o destrutiva.
create schema if not exists sigov;
...
insert into sigov.permissao (modulo,recurso,acao,chave,descricao,ativo) values
('comercio','dashboard','visualizar','comercio.dashboard.visualizar','Visualizar dashboard comercial avanÃƒÆ’Ã‚Â§ado',true),
...
('comercio','orcamentos','visualizar','comercio.orcamentos.visualizar','Visualizar orÃƒÆ’Ã‚Â§amentos',true),
('comercio','orcamentos','criar','comercio.orcamentos.criar','Criar orÃƒÆ’Ã‚Â§amentos',true),
('comercio','orcamentos','aprovar','comercio.orcamentos.aprovar','Aprovar orÃƒÆ’Ã‚Â§amentos',true),
...
('comercio','tabelas','visualizar','comercio.tabelas.visualizar','Visualizar tabelas de preÃƒÆ’Ã‚Â§o',true),
('comercio','tabelas','editar','comercio.tabelas.editar','Editar tabelas de preÃƒÆ’Ã‚Â§o',true),
('comercio','comissoes','visualizar','comercio.comissoes.visualizar','Visualizar comissÃƒÆ’Ã‚Âµes',true),
('comercio','comissoes','calcular','comercio.comissoes.calcular','Calcular comissÃƒÆ’Ã‚Âµes',true),
...
insert into sigov.tenant_modulo_pacote (codigo, nome, descricao, modulos_json) values
('COMERCIO_STARTER','ComÃƒÆ’Ã‚Â©rcio Starter','Varejo com PDV, caixa e estoque.','["comercial","comercio_varejo","pdv","caixa","estoque_compras"]'::jsonb),
('COMERCIO_PLUS','ComÃƒÆ’Ã‚Â©rcio Plus','Varejo e atacado integrados ao estoque e financeiro inicial.','["comercial","comercio_varejo","comercio_atacado","pdv","caixa","estoque_compras","financeiro_empresarial"]'::jsonb),
('ATACADO_PRO','Atacado Pro','Pedidos, separaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o e financeiro inicial para atacado.','["comercial","comercio_atacado","pedidos","estoque_compras","financeiro_empresarial"]'::jsonb),
('BUSINESS_FULL','Business Full','ComÃƒÆ’Ã‚Â©rcio, OS, manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o industrial, estoque e financeiro inicial integrados.','["comercial","comercio_varejo","comercio_atacado","pdv","caixa","estoque_compras","ordem_servico","manutencao_industrial","financeiro_empresarial"]'::jsonb)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, modulos_json=excluded.modulos_json, ativo=true;
...
('COMERCIO_STARTER','ComÃƒÆ’Ã‚Â©rcio Starter','Plano inicial de varejo com PDV, caixa e estoque.','MENSAL',0,'BRL','MENSAL',20,true,true,true,50),
('COMERCIO_PLUS','ComÃƒÆ’Ã‚Â©rcio Plus','Plano integrado para varejo e atacado com financeiro comercial inicial.','MENSAL',0,'BRL','MENSAL',60,true,true,true,60),
('ATACADO_PRO','Atacado Pro','Plano atacadista com pedidos, separaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, estoque e contas a receber.','MENSAL',0,'BRL','MENSAL',80,true,false,true,70),
('BUSINESS_FULL','Business Full','Plano empresarial completo com comÃƒÆ’Ã‚Â©rcio, OS, manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, estoque e financeiro inicial.','MENSAL',0,'BRL','MENSAL',200,false,false,true,80)
...
-- SIGOV PÃƒÆ’Ã‚Â³s-Build 06: IndÃƒÆ’Ã‚Âºstria e ProduÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o avanÃƒÆ’Ã‚Â§ada, chÃƒÆ’Ã‚Â£o de fÃƒÆ’Ã‚Â¡brica e integraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes.
-- Migration idempotente: CREATE TABLE/INDEX IF NOT EXISTS e seeds com ON CONFLICT, sem remoÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o destrutiva.
create schema if not exists sigov;
create extension if not exists pgcrypto;
...
('industria_producao','IndÃƒÆ’Ã‚Âºstria e ProduÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','ProduÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o por ordem, BOM, roteiro, chÃƒÆ’Ã‚Â£o de fÃƒÆ’Ã‚Â¡brica, qualidade e custos.','EMPRESARIAL',true),
('manutencao_industrial','ManutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o Industrial','Ativos, planos e manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o industrial integrada.','EMPRESARIAL',true),
('ordem_servico','Ordem de ServiÃƒÆ’Ã‚Â§o','Ordens de serviÃƒÆ’Ã‚Â§o tÃƒÆ’Ã‚Â©cnicas e operacionais.','EMPRESARIAL',true),
...
('comercio_varejo','ComÃƒÆ’Ã‚Â©rcio Varejo','Varejo, balcÃƒÆ’Ã‚Â£o e operaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes de loja.','EMPRESARIAL',true),
('comercio_atacado','ComÃƒÆ’Ã‚Â©rcio Atacado','Pedidos, tabelas e separaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o atacadista.','EMPRESARIAL',true),
...
insert into sigov.tenant_modulo_pacote (codigo, nome, descricao, modulos_json) values
('INDUSTRIAL_STARTER','Industrial Starter','ProduÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, estoque e ordem de serviÃƒÆ’Ã‚Â§o para iniciar operaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o industrial.','["industria_producao","estoque_compras","ordem_servico"]'::jsonb),
('INDUSTRIAL_PLUS','Industrial Plus','ProduÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o integrada a manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, OS, compras, estoque e financeiro.','["industria_producao","manutencao_industrial","ordem_servico","estoque_compras","compras","financeiro_empresarial"]'::jsonb),
('FACTORY_FULL','Factory Full','Pacote fabril completo com comercial atacadista, produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, estoque e financeiro.','["industria_producao","manutencao_industrial","ordem_servico","estoque_compras","comercial","comercio_atacado","financeiro_empresarial"]'::jsonb),
('BUSINESS_FULL','Business Full','Pacote empresarial completo com comÃƒÆ’Ã‚Â©rcio, produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, OS, manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, estoque e financeiro.','["comercial","comercio_varejo","comercio_atacado","pdv","caixa","estoque_compras","ordem_servico","manutencao_industrial","industria_producao","financeiro_empresarial"]'::jsonb)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, modulos_json=excluded.modulos_json, ativo=true;

insert into sigov.saas_plano (codigo,nome,descricao,tipo_plano,preco_base,moeda,periodicidade,limite_usuarios,publico,destaque,ativo,ordem) values
('INDUSTRIAL_STARTER','Industrial Starter','IndÃƒÆ’Ã‚Âºstria por ordem com estoque e OS.','MENSAL',0,'BRL','MENSAL',40,true,true,true,90),
('INDUSTRIAL_PLUS','Industrial Plus','IndÃƒÆ’Ã‚Âºstria integrada com manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, compras e financeiro.','MENSAL',0,'BRL','MENSAL',120,true,true,true,100),
('FACTORY_FULL','Factory Full','OperaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o fabril e comercial atacadista completa.','MENSAL',0,'BRL','MENSAL',180,true,false,true,110),
('BUSINESS_FULL','Business Full','Empresa completa: comercial, estoque, OS, manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, indÃƒÆ’Ã‚Âºstria e financeiro.','MENSAL',0,'BRL','MENSAL',250,false,false,true,120)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, limite_usuarios=excluded.limite_usuarios, publico=excluded.publico, destaque=excluded.destaque, ativo=true, updated_at=now();
...
('Gerente Industrial','Gerencia produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, chÃƒÆ’Ã‚Â£o de fÃƒÆ’Ã‚Â¡brica, custos e indicadores.','GERENTE_INDUSTRIAL',true),
('PCP','Planeja e libera ordens de produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o.','PCP',true),
('Operador de ProduÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','Realiza apontamentos de chÃƒÆ’Ã‚Â£o de fÃƒÆ’Ã‚Â¡brica.','OPERADOR_PRODUCAO',true),
('Qualidade','Executa inspeÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes e liberaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes de qualidade.','QUALIDADE',true),
('ManutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','Atua em paradas e OS de manutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o.','MANUTENCAO',true)
on conflict do nothing;
...
('industria','fichas','visualizar','industria.fichas.visualizar','Visualizar fichas tÃƒÆ’Ã‚Â©cnicas',true),
('industria','fichas','criar','industria.fichas.criar','Criar fichas tÃƒÆ’Ã‚Â©cnicas',true),
('industria','fichas','editar','industria.fichas.editar','Editar fichas tÃƒÆ’Ã‚Â©cnicas',true),
...
('industria','ordens','visualizar','industria.ordens.visualizar','Visualizar ordens de produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('industria','ordens','criar','industria.ordens.criar','Criar ordens de produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('industria','ordens','liberar','industria.ordens.liberar','Liberar ordens de produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('industria','ordens','iniciar','industria.ordens.iniciar','Iniciar ordens de produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
('industria','ordens','concluir','industria.ordens.concluir','Concluir ordens de produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o',true),
...
('industria','producao','registrar','industria.producao.registrar','Registrar produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o acabada',true),
...
('industria','chao_fabrica','acessar','industria.chao_fabrica.acessar','Acessar chÃƒÆ’Ã‚Â£o de fÃƒÆ’Ã‚Â¡brica',true)
on conflict (modulo,recurso,acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;
...
('financeiro_empresarial','Financeiro Empresarial','Plano de contas, centros de custo, contas, baixas, movimentos, fluxo de caixa e conciliaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o.','GestÃƒÆ’Ã‚Â£o empresarial',45,'/Financeiro/Dashboard','bi-bank',true),
('financeiro_publico','Financeiro PÃƒÆ’Ã‚Âºblico','Base futura para SIAFIC e financeiro pÃƒÆ’Ã‚Âºblico integrado.','GestÃƒÆ’Ã‚Â£o pÃƒÆ’Ã‚Âºblica',46,'/Financeiro/Dashboard','bi-building-lock',true)
...
-- SIGOV - EvoluÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o PÃƒÆ’Ã‚Â³s-Build 08: TributÃƒÆ’Ã‚Â¡rio AvanÃƒÆ’Ã‚Â§ado e Fiscal Integrado
...
insert into sigov.permissao (modulo,recurso,acao,chave,descricao,ativo) values
('tributario','dashboard','visualizar','tributario.dashboard.visualizar','Visualizar dashboard tributÃƒÆ’Ã‚Â¡rio avanÃƒÆ’Ã‚Â§ado',true),
...
('tributario','divida_ativa','visualizar','tributario.divida_ativa.visualizar','Visualizar dÃƒÆ’Ã‚Â­vida ativa',true),
('tributario','divida_ativa','editar','tributario.divida_ativa.editar','Editar dÃƒÆ’Ã‚Â­vida ativa',true),
('tributario','parcelamento','visualizar','tributario.parcelamento.visualizar','Visualizar parcelamentos tributÃƒÆ’Ã‚Â¡rios',true),
('tributario','parcelamento','editar','tributario.parcelamento.editar','Editar parcelamentos tributÃƒÆ’Ã‚Â¡rios',true),
('tributario','arrecadacao','visualizar','tributario.arrecadacao.visualizar','Visualizar arrecadaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o tributÃƒÆ’Ã‚Â¡ria',true),
('tributario','arrecadacao','registrar','tributario.arrecadacao.registrar','Registrar arrecadaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o tributÃƒÆ’Ã‚Â¡ria',true),
...
('tributario','livro_eletronico','visualizar','tributario.livro_eletronico.visualizar','Visualizar livro eletrÃƒÆ’Ã‚Â´nico tributÃƒÆ’Ã‚Â¡rio',true),
('tributario','livro_eletronico','gerar','tributario.livro_eletronico.gerar','Gerar livro eletrÃƒÆ’Ã‚Â´nico tributÃƒÆ’Ã‚Â¡rio',true)
on conflict (modulo,recurso,acao) do update set chave=excluded.chave, descricao=excluded.descricao, ativo=true;

insert into sigov.perfil_acesso (nome, descricao, codigo_externo, ativo) values
('TributÃƒÆ’Ã‚Â¡rio Admin','Administra IPTU, ISS, taxas, DAM, dÃƒÆ’Ã‚Â­vida ativa, NFS-e simulada e livro eletrÃƒÆ’Ã‚Â´nico.','TRIBUTARIO_ADMIN',true),
('Fiscal TributÃƒÆ’Ã‚Â¡rio','Opera lanÃƒÆ’Ã‚Â§amentos, arrecadaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o, parcelamentos e relatÃƒÆ’Ã‚Â³rios fiscais.','FISCAL_TRIBUTARIO',true),
('Consulta TributÃƒÆ’Ã‚Â¡ria','Consulta dashboard, livro eletrÃƒÆ’Ã‚Â´nico e relatÃƒÆ’Ã‚Â³rios fiscais.','CONSULTA_TRIBUTARIA',true)
on conflict do nothing;
...
insert into sigov.tenant_modulo_pacote (codigo, nome, descricao, modulos_json) values
('GOV_TRIBUTARIO_PLUS','Gov TributÃƒÆ’Ã‚Â¡rio Plus','Pacote fiscal municipal com TributÃƒÆ’Ã‚Â¡rio AvanÃƒÆ’Ã‚Â§ado, Financeiro PÃƒÆ’Ã‚Âºblico e LGPD.', '["tributario","financeiro_publico","auditoria-lgpd"]'::jsonb)
...
from sigov.tenant t
cross join (values
    ('IPTU','Imposto Predial e Territorial Urbano','IPTU',1.0000,'CÃƒÆ’Ã‚Â³digo TributÃƒÆ’Ã‚Â¡rio Municipal - IPTU','IMOBILIARIO'),
    ('ISS','Imposto Sobre ServiÃƒÆ’Ã‚Â§os','ISS',2.0000,'CÃƒÆ’Ã‚Â³digo TributÃƒÆ’Ã‚Â¡rio Municipal - ISS','SERVICO'),
    ('TAXA_COLETA','Taxa de Coleta de ResÃƒÆ’Ã‚Â­duos','TAXA',0.0000,'CÃƒÆ’Ã‚Â³digo TributÃƒÆ’Ã‚Â¡rio Municipal - Taxas','SERVICO')
...
-- SIGOV PLUS - PÃƒÆ’Ã‚Â³s-Build 09: GED/OCR, assinatura digital simulada e automaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o documental.
...
('ged','tramitacao','tramitar','ged.tramitar','Tramitar documentos e protocolos eletrÃƒÆ’Ã‚Â´nicos.',true),
('contrato','contrato','visualizar','contrato.visualizar','Visualizar contratos jurÃƒÆ’Ã‚Â­dicos e comerciais.',true),
...
from sigov.tenant t
cross join (values
    ('CONTRATO','Contrato','Instrumentos jurÃƒÆ’Ã‚Â­dicos, comerciais e administrativos.',true,true,'["numero","vigencia","contratado"]'),
    ('DOCUMENTO_FISCAL','Documento fiscal','Notas, DAM, comprovantes e livros fiscais vinculados ao TributÃƒÆ’Ã‚Â¡rio.',false,true,'["competencia","valor","origem"]'),
    ('CHECKLIST_PRODUCAO','Checklist de produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','Checklist, qualidade e evidÃƒÆ’Ã‚Âªncias de ordens industriais.',false,true,'["ordem","produto","etapa"]'),
    ('PROTOCOLO','Protocolo eletrÃƒÆ’Ã‚Â´nico','Documentos recebidos via protocolo e atendimento.',false,true,'["numero_protocolo","canal"]')
...
from sigov.tenant t
cross join (values
    ('TPL_CONTRATO_PADRAO','Contrato padrÃƒÆ’Ã‚Â£o','CONTRATO','Contrato nÃƒâ€šÃ‚Âº {{numero}} firmado com {{contratado}} no valor de {{valor_total}}.','["numero","contratado","valor_total"]'),
    ...
    ('TPL_CHECKLIST_OP','Checklist de ordem de produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','CHECKLIST_PRODUCAO','Checklist da ordem {{ordem}} para produto {{produto}} na etapa {{etapa}}.','["ordem","produto","etapa"]')
...
select t.id, 'WF_GED_BASICO', 'Workflow bÃƒÆ’Ã‚Â¡sico GED/OCR/Assinatura', 'RECEBIMENTO', 'ATIVO', '{"etapas":["RECEBIMENTO","OCR","INDEXACAO","TRAMITACAO","ASSINATURA","ARQUIVAMENTO"],"assinatura":"SIMULADA"}'::jsonb
from sigov.tenant t
where t.slug in ('plataforma-global','prefeitura-demo','tenant-demo')
...
insert into sigov.tenant_modulo_pacote (codigo, nome, descricao, modulos_json) values
('GED_AUTOMACAO_PLUS','GED AutomaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o Plus','GED completo com OCR simulado, contratos, protocolos, workflow, tramitaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o e assinatura digital simulada.', '["ged","ocr","contrato","fluxo","processos","integracoes","auditoria-lgpd"]'::jsonb)
on conflict (codigo) do update set nome=excluded.nome, descricao=excluded.descricao, modulos_json=excluded.modulos_json;
...
-- PÃƒÆ’Ã‚Â³s-Build 11: IA, automaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o inteligente, assistentes operacionais e anÃƒÆ’Ã‚Â¡lise preditiva
...
('INTERNO','Provider interno heurÃƒÆ’Ã‚Â­stico','INTERNO',null,true),
('LOCAL','Provider local configurÃƒÆ’Ã‚Â¡vel','LOCAL',null,true),
('OPENAI','OpenAI configurÃƒÆ’Ã‚Â¡vel','OPENAI',null,false),
('AZURE_OPENAI','Azure OpenAI configurÃƒÆ’Ã‚Â¡vel','AZURE_OPENAI',null,false)
...
('ASSISTENTE_TRIBUTARIO','Assistente TributÃƒÆ’Ã‚Â¡rio','Apoio a anÃƒÆ’Ã‚Â¡lises fiscais e arrecadaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o.','TRIBUTARIO',true),
('ASSISTENTE_FINANCEIRO','Assistente Financeiro','Apoio a fluxo de caixa, cobranÃƒÆ’Ã‚Â§a e inadimplÃƒÆ’Ã‚Âªncia.','FINANCEIRO',true),
('ASSISTENTE_GED','Assistente GED','Resumo, classificaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o e extraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o documental.','GED',true),
('ASSISTENTE_COMERCIAL','Assistente Comercial','Apoio a clientes, leads e oportunidades.','COMERCIAL',true),
('ASSISTENTE_INDUSTRIA','Assistente IndÃƒÆ’Ã‚Âºstria','Apoio ao chÃƒÆ’Ã‚Â£o de fÃƒÆ’Ã‚Â¡brica e produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o.','INDUSTRIA',true),
('ASSISTENTE_OS','Assistente OS','Apoio a ordens de serviÃƒÆ’Ã‚Â§o.','OS',true),
('ASSISTENTE_JURIDICO','Assistente JurÃƒÆ’Ã‚Â­dico','GeraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o assistida de pareceres.','JURIDICO',true),
...
(null,'resumo_processo','Resumo de processo','protocolo','RESUMO','Resuma o processo e sugira prÃƒÆ’Ã‚Â³ximos passos sem executar aÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes crÃƒÆ’Ã‚Â­ticas.',false,true),
(null,'resumo_os','Resumo de OS','ordem_servico','RESUMO','Resuma o histÃƒÆ’Ã‚Â³rico da OS e a prÃƒÆ’Ã‚Â³xima aÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o segura.',false,true),
(null,'resumo_contrato','Resumo de contrato','contrato','RESUMO','Resuma contrato, vigÃƒÆ’Ã‚Âªncia, clÃƒÆ’Ã‚Â¡usulas e riscos.',false,true),
(null,'classificar_documento','Classificar documento','ged','CLASSIFICACAO','Classifique por palavras-chave e indique confianÃƒÆ’Ã‚Â§a.',false,true),
(null,'extrair_dados_documento','Extrair dados de documento','ged','EXTRACAO','Extraia nÃƒÆ’Ã‚Âºmero, datas, valores e partes, mascarando dados sensÃƒÆ’Ã‚Â­veis.',false,true),
(null,'gerar_relatorio_financeiro','Gerar relatÃƒÆ’Ã‚Â³rio financeiro','financeiro_empresarial','RELATORIO','Gere relatÃƒÆ’Ã‚Â³rio textual financeiro com riscos e oportunidades.',false,true),
(null,'gerar_parecer_juridico','Gerar parecer jurÃƒÆ’Ã‚Â­dico','juridico','PARECER','Rascunhe parecer para revisÃƒÆ’Ã‚Â£o humana obrigatÃƒÆ’Ã‚Â³ria.',true,true),
(null,'gerar_despacho_protocolo','Gerar despacho de protocolo','protocolo','DESPACHO','Rascunhe despacho administrativo para revisÃƒÆ’Ã‚Â£o humana.',true,true),
(null,'sugerir_acoes_cobranca','Sugerir aÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes de cobranÃƒÆ’Ã‚Â§a','financeiro_empresarial','SUGESTAO','Sugira aÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes de cobranÃƒÆ’Ã‚Â§a sem baixa financeira automÃƒÆ’Ã‚Â¡tica.',true,true),
(null,'prever_inadimplencia','Prever inadimplÃƒÆ’Ã‚Âªncia','financeiro_empresarial','ANALISE','Estime risco de inadimplÃƒÆ’Ã‚Âªncia por regras.',false,true),
(null,'prever_atraso_os','Prever atraso OS','ordem_servico','ANALISE','Estime risco de atraso em OS.',false,true),
(null,'prever_ruptura_estoque','Prever ruptura estoque','estoque_compras','ANALISE','Estime risco de ruptura por saldo e estoque mÃƒÆ’Ã‚Â­nimo.',false,true),
(null,'sugerir_reposicao_estoque','Sugerir reposiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','estoque_compras','SUGESTAO','Sugira compra/reposiÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o com confirmaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o humana.',true,true),
(null,'analisar_fluxo_caixa','Analisar fluxo de caixa','financeiro_empresarial','ANALISE','Analise tendÃƒÆ’Ã‚Âªncias e alertas no fluxo de caixa.',false,true),
(null,'analisar_producao_atrasada','Analisar produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o atrasada','industria_producao','ANALISE','Identifique risco e causa provÃƒÆ’Ã‚Â¡vel de atraso produtivo.',false,true)
...
('inadimplencia_cliente','InadimplÃƒÆ’Ã‚Âªncia de cliente','Modelo heurÃƒÆ’Ã‚Â­stico inicial.','financeiro_empresarial','INADIMPLENCIA',true),
('atraso_ordem_servico','Atraso em ordem de serviÃƒÆ’Ã‚Â§o','Modelo heurÃƒÆ’Ã‚Â­stico inicial.','ordem_servico','ATRASO_OS',true),
('ruptura_estoque','Ruptura de estoque','Modelo heurÃƒÆ’Ã‚Â­stico inicial.','estoque_compras','ESTOQUE_RUPTURA',true),
('risco_contrato','Risco contratual','Modelo heurÃƒÆ’Ã‚Â­stico inicial.','contrato','CONTRATO_RISCO',true),
('atraso_producao','Atraso de produÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','Modelo heurÃƒÆ’Ã‚Â­stico inicial.','industria_producao','PRODUCAO_ATRASO',true),
('queda_arrecadacao','Queda de arrecadaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o','Modelo heurÃƒÆ’Ã‚Â­stico inicial.','tributario','ARRECADACAO',true),
('churn_saas','Churn SaaS','Modelo heurÃƒÆ’Ã‚Â­stico inicial.','operacao-saas','CHURN',true)
...
insert into sigov.modulo_saas(codigo,nome,descricao,categoria,ordem,rota_base,icone,ativo) values
('ia_assistente','IA Assistente','Assistentes inteligentes por mÃƒÆ’Ã‚Â³dulo, seguros e auditÃƒÆ’Ã‚Â¡veis.','InteligÃƒÆ’Ã‚Âªncia',900,'/IA/Assistente','bi-robot',true),
('ia_documental','IA Documental','Resumo, classificaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o e extraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o estruturada de documentos.','InteligÃƒÆ’Ã‚Âªncia',901,'/IA/Documental','bi-file-earmark-text',true),
('ia_relatorios','IA RelatÃƒÆ’Ã‚Â³rios','GeraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o assistida de relatÃƒÆ’Ã‚Â³rios textuais.','InteligÃƒÆ’Ã‚Âªncia',902,'/IA/Relatorios','bi-bar-chart-line',true),
('ia_automacoes','IA AutomaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes','SugestÃƒÆ’Ã‚Âµes, alertas e workflows com confirmaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o humana.','InteligÃƒÆ’Ã‚Âªncia',903,'/IA/Automacoes','bi-diagram-3',true),
('ia_predicoes','IA PrediÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes','AnÃƒÆ’Ã‚Â¡lise preditiva inicial baseada em regras.','InteligÃƒÆ’Ã‚Âªncia',904,'/IA/Predicoes','bi-graph-up-arrow',true)
...
('ia_1000_interacoes','IA 1.000 interaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes','Pacote mensal adicional de 1.000 interaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes de IA.','IA_CONSUMO','ia_assistente',null,'MENSAL'),
('ia_10000_interacoes','IA 10.000 interaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes','Pacote mensal adicional de 10.000 interaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes de IA.','IA_CONSUMO','ia_assistente',null,'MENSAL'),
('ia_ocr_avancado','IA OCR avanÃƒÆ’Ã‚Â§ado','Capacidades avanÃƒÆ’Ã‚Â§adas de OCR e extraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o.','IA_RECURSO','ia_documental',null,'MENSAL'),
('ia_relatorios_avancados','IA relatÃƒÆ’Ã‚Â³rios avanÃƒÆ’Ã‚Â§ados','RelatÃƒÆ’Ã‚Â³rios assistidos avanÃƒÆ’Ã‚Â§ados.','IA_RECURSO','ia_relatorios',null,'MENSAL'),
('ia_automacoes_avancadas','IA automaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes avanÃƒÆ’Ã‚Â§adas','Workflows inteligentes avanÃƒÆ’Ã‚Â§ados.','IA_RECURSO','ia_automacoes',null,'MENSAL')
on conflict(codigo) do update set nome=excluded.nome,descricao=excluded.descricao,tipo_addon=excluded.tipo_addon,modulo_codigo=excluded.modulo_codigo;

insert into sigov.tenant_modulo_pacote(codigo,nome,descricao,modulos_json) values
('AI_STARTER','AI Starter','Assistente e relatÃƒÆ’Ã‚Â³rios por IA.','["ia_assistente","ia_relatorios"]'::jsonb),
...
('GOV_FULL_AI','Gov Full AI','Governo com IA documental, relatÃƒÆ’Ã‚Â³rios e automaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes.','["tributario","protocolo","ged","contratos","financeiro_publico","ia_assistente","ia_documental","ia_relatorios","ia_automacoes"]'::jsonb)
on conflict(codigo) do update set nome=excluded.nome,descricao=excluded.descricao,modulos_json=excluded.modulos_json;
...
('ia','execucoes','visualizar','ia.execucoes.visualizar','Visualizar execuÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes IA',true),
('ia','sugestoes','visualizar','ia.sugestoes.visualizar','Visualizar sugestÃƒÆ’Ã‚Âµes IA',true),
('ia','sugestoes','aprovar','ia.sugestoes.aprovar','Aprovar sugestÃƒÆ’Ã‚Âµes IA',true),
('ia','sugestoes','aplicar','ia.sugestoes.aplicar','Aplicar sugestÃƒÆ’Ã‚Âµes IA',true),
('ia','sugestoes','rejeitar','ia.sugestoes.rejeitar','Rejeitar sugestÃƒÆ’Ã‚Âµes IA',true),
...
('ia','relatorios','gerar','ia.relatorios.gerar','Gerar relatÃƒÆ’Ã‚Â³rios por IA',true),
('ia','automacoes','visualizar','ia.automacoes.visualizar','Visualizar automaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes IA',true),
('ia','automacoes','criar','ia.automacoes.criar','Criar automaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes IA',true),
('ia','automacoes','editar','ia.automacoes.editar','Editar automaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes IA',true),
('ia','automacoes','executar','ia.automacoes.executar','Executar automaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes IA',true),
...
('ia','predicoes','visualizar','ia.predicoes.visualizar','Visualizar prediÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes IA',true),
('ia','predicoes','executar','ia.predicoes.executar','Executar prediÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Âµes IA',true),
('ia','configuracao','visualizar','ia.configuracao.visualizar','Visualizar configuraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o IA',true),
('ia','configuracao','editar','ia.configuracao.editar','Editar configuraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o IA',true),
...
-- SIGOV PÃƒÆ’Ã‚Â³s-Build 12: Mobile/PWA, Campo, Offline First, Georreferenciamento e SincronizaÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o
create schema if not exists sigov;
...
create table if not exists sigov.campo_localizacao (
  ...
  regra_operacional text not null default 'Coleta opcional conforme permissÃƒÆ’Ã‚Â£o e finalidade operacional.',
  capturado_at timestamptz not null default now(),
  created_at timestamptz not null default now()
);
...
(1,'checklist_os_tecnica','Checklist OS TÃƒÆ’Ã‚Â©cnica','ordem_servico','ORDEM_SERVICO'),
(1,'checklist_visita_social','Checklist Visita Social','social','VISITA'),
(1,'checklist_visita_acs','Checklist Visita ACS','saude','VISITA'),
(1,'checklist_leitura_hidrometro','Checklist Leitura de HidrÃƒÆ’Ã‚Â´metro','saneamento','LEITURA'),
(1,'checklist_vistoria_tributaria','Checklist Vistoria TributÃƒÆ’Ã‚Â¡ria','tributario','FISCALIZACAO'),
(1,'checklist_visita_agro','Checklist Visita Agro','agro','VISITA'),
(1,'checklist_manutencao_industrial','Checklist ManutenÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o Industrial','manutencao_industrial','MANUTENCAO'),
...
join (values
('checklist_os_tecnica','seguranca','Checklist de seguranÃƒÆ’Ã‚Â§a preenchido?','SIM_NAO',true,1),
...
('checklist_visita_acs','domicilio','DomicÃƒÆ’Ã‚Â­lio visitado?','SIM_NAO',true,1),
...
(1,'Mobile/PWA habilitado','Ambiente mobile, offline sync e campo operacional disponÃƒÆ’Ã‚Â­veis para demonstraÃƒÆ’Ã‚Â§ÃƒÆ’Ã‚Â£o.','INFO',true)
on conflict do nothing;

-- Tokens/seeds pesquisÃƒÆ’Ã‚Â¡veis pelo script completo/testes estÃƒÆ’Ã‚Â¡ticos: mobile_usuarios_extra, storage_fotos_campo, geolocalizacao_avancada, sincronizacao_offline_avancada,
...
-- PermissÃƒÆ’Ã‚Âµes PÃƒÆ’Ã‚Â³s-Build 12:
