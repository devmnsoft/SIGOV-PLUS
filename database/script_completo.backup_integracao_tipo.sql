...
begin
    ...
    values ('Prefeitura Municipal de DemonstraÃƒÂ§ÃƒÂ£o', '00000000000191', true, 'Registro de desenvolvimento sigov')
    ...
    values
        (v_entidade_id, v_exercicio_id, 'core', 'core_admin', 'PermissÃƒÂ£o administrativa do nÃƒÂºcleo', true),
        (v_entidade_id, v_exercicio_id, 'seguranca', 'seguranca_admin', 'PermissÃƒÂ£o administrativa de seguranÃƒÂ§a', true),
        (v_entidade_id, v_exercicio_id, 'auditoria', 'auditoria_admin', 'PermissÃƒÂ£o administrativa de auditoria', true),
        (v_entidade_id, v_exercicio_id, 'lgpd', 'lgpd_admin', 'PermissÃƒÂ£o administrativa LGPD', true),
        (v_entidade_id, v_exercicio_id, 'suporte', 'suporte_admin', 'PermissÃƒÂ£o administrativa de suporte', true),
        (v_entidade_id, v_exercicio_id, 'conformidade', 'aderencia_admin', 'PermissÃƒÂ£o administrativa de conformidade e aderÃƒÂªncia', true)
    on conflict do nothing;
...
-- comando legado omitido por regra de seguranÃƒÂ§a sem remoÃƒÂ§ÃƒÂ£o destrutiva.
            end if;
        end if;
    end loop;
end $$;
